...
Verified hotel facts you may use: 3.2 km from Hazrat Shahjalal International Airport (about 10 minutes), 25+ Mbps WiFi throughout, room tiers ৳4,000–৳4,500/night, 24/7 front desk.
...
ALSO design each post's social graphic as "design_html" — one self-contained HTML snippet for the Satori renderer, under 3500 characters. Canvas: 4:5 portrait (width:1080px;height:1350px on the root div) is the DEFAULT for feed posts; 1080x1080 square is allowed for grid-style layouts. BANNER DOCTRINE (owner's design skill): headline on the graphic ≤ 8 words and total on-image text visually under ~20% of the canvas (the caption carries detail, the graphic carries the hook); eye path top-to-bottom = hero visual → core value → CTA; the CTA is ALWAYS a gold container (solid #D4AF37 with #1C1510 text, or gold-bordered pill) with a 2-5 word action phrase like "Book Direct & Save", "Reserve My Room", "WhatsApp Live Booking" plus the number. Template archetype by post type: OFFER/rate → Direct Deal (photo ~60% of frame, value panel ~40% with bold price badge); TESTIMONIAL → quote in a frosted or gold-bordered container over a photo; amenity/feature → asymmetric Bento; travel-guide → local infographic with distance metrics (3.2 km HSIA → lobby); event/F&B/rooftop → dark saturated + warm gold glow, where warm accents terracotta #C2603D / amber #E8A13C are permitted. STRICT RENDERER RULES: only <div>, <span>, <img>; ALL styling inline; EVERY div must include display:flex plus a flex-direction; position:absolute is allowed for overlays/glow shapes; no grid, no scripts, no external CSS; fonts: Inter is the default sans; headline typefaces may be font-family:Playfair (serif display — luxury, suites, editorial), font-family:Cormorant (elegant serif — dining, events), or font-family:SpaceGrotesk (geometric — corporate, tech, bento); use font-family:Bengali for Bangla text and any ৳ price; maximum 2 display families per design. Images may ONLY be these exact URLs: https://fountainbd.com/logo-crest.png (logo), https://fountainbd.com/fountain-deluxe.jpeg, https://fountainbd.com/premium-deluxe.jpg, https://fountainbd.com/royal-suite.jpeg, https://fountainbd.com/superior-deluxe.jpeg, https://fountainbd.com/twin-deluxe.jpg (room photos), https://mynwfkgksqqwlqowlscj.supabase.co/storage/v1/object/public/crm-assets/marketing/fountain-suite-room.jpg (Fountain Suite, warm twin-king shot — pairs beautifully with gold), https://mynwfkgksqqwlqowlscj.supabase.co/storage/v1/object/public/crm-assets/marketing/rooftop-night.jpg (rooftop cafe at night — evening/dining angles). Root element: <div style="display:flex;flex-direction:column;width:1080px;height:1080px;...">.
MASTER PALETTE (owner-locked 2026-07-05, matches fountainbd.com's luxury look): deep walnut/charcoal backgrounds (#171310, #221A12, #120E0A gradients or #0F0C09 flat), Premium Gold #D4AF37 for accents, frames, dividers and hero numbers, ivory #F5EFE4 primary text, muted #B8AD9C secondary. NEVER use teal, green, lime, or blue anywhere.
ANTI-SAMENESS RULES (hard requirement — the owner rejects batches that look templated): across the batch NO two designs may share the same layout skeleton. Vary INDEPENDENTLY per post: canvas (4:5 vs 1:1), scheme (dark walnut vs LIGHT ivory editorial vs event dark-glow — at least one light design per batch), photo treatment (full-bleed photo with gradient scrim and text overlaid ON the photo / inset framed photo card / split half-photo half-panel / bento tiles / typography-only with no photo), headline typeface (rotate Playfair, Inter, SpaceGrotesk), price placement (giant centerpiece vs corner badge vs inline), and CTA shape (full-width solid bar vs pill vs compact corner block). A batch where every design is photo-top + panel + CTA-bar is a FAILURE.
ROTATE the visual style across the ${wanted} posts — assign each post ONE of these three house styles, never the same style twice in a row:
STYLE A "Gold Glass": walnut gradient background with position:absolute radial-gradient gold glow circles rgba(212,175,55,0.16); frosted cards (background rgba(255,255,255,0.05), 1px border rgba(212,175,55,0.45), border-radius 26-28); hero number in #D4AF37 with text-shadow 0 0 26px rgba(212,175,55,0.55); pill CTA with gold border on rgba(212,175,55,0.14).
STYLE B "Ivory Editorial": background #FBF9F5, generous whitespace, deep walnut #1C1510 headline type, muted #8A8375 secondary, hairline 1px #E5E0D6 dividers, #D4AF37 accents (thin bar, small ◆ separators), giant price or headline as the centerpiece, small logo bottom-right; photo optional.
STYLE C "Bento Grid": background #0F0C09, asymmetric tile mosaic from nested flex columns/rows with gap 20, tiles background rgba(255,255,255,0.04) with 1px borders rgba(255,255,255,0.12) and border-radius 20-24, price/hero tile with border rgba(212,175,55,0.55) and gold gradient tint rgba(212,175,55,0.12), CTA tile background #D4AF37 with #1C1510 bold text, #D4AF37 headers.
