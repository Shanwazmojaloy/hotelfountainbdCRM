...
- **BILLING REPORT — A4 PORTRAIT (2026-06-02)**: Download Report uses `@page{size:A4 portrait;margin:5mm 7mm}` and tighter print rules (font 7.5px, table padding 2.5px 4px, stats `repeat(4,1fr)`, closing max-width 300px). Owner-confirmed portrait over landscape on 2026-06-02. If repagination causes overflow when guest counts grow, prefer trimming columns over reverting to landscape.
