  ...
  return (
    <div onClick={onClose} className="iv-modal-ov" style={{ position: 'fixed', inset: 0, background: 'rgba(7,9,14,0.58)', zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div onClick={(e) => e.stopPropagation()} className="iv-card" style={{ width: '100%', maxWidth: 460, maxHeight: '92vh', overflowY: 'auto' }}>
        ...
        {!isEdit && <div className="mb-4 text-sm" style={{ color: '#7BE04A', background: 'rgba(123,224,74,0.07)', border: '1px solid rgba(123,224,74,0.18)', borderRadius: 8, padding: '8px 12px' }}>
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap iv-foot">
          <div className="flex gap-2">
            {isEdit && <button className="iv-btn iv-btn--ghost" style={{ color: '#FF6B6B' }} onClick={remove} disabled={saving}>Remove</button>}
