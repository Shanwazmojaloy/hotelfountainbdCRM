...
// ─────────────────────────────────────────────────────────────
// Email Confirmation API  –  Pages Router (/pages/api/)
//
// Using Pages Router instead of App Router because Next.js 16 +
// Turbopack has a regression where App Router Route Handlers are
// silently excluded from the Vercel serverless build output.
// Pages Router API routes compile reliably every time.
//
