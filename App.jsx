...
function computeBill(r, rooms, foliosMap, settings) {
  ...
  const folios=foliosMap[fKey]||foliosMap[r.room_number]||[]
...
:root{
  ...
  --tx:#EEE9E2;--tx2:#B8A890;--tx3:#9A907C;
  ...
  return (
    <div>
                          ...
                          {currentUser?.role!=='housekeeping'&&(
                            <button className="btn btn-ghost btn-sm" style={{padding:'3px 9px',fontSize:9,marginRight:4}} onClick={()=>{
                              ...
                              printInvoice(
                                ...
                                invoice,tTotal,tPaid,tDue,pInvoiceByType
                              )
                            }}>🖨 Print</button>
                          )}
      ...
      {showBillDetail&&detailRes&&(()=>{
        ...
        const {roomCharge,sub,total,paid,due,folios,nights,roomRate}=computeBill(r)
