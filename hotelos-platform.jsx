...
/* ═══════════════════════════════════════════════════════════════════════
   HOTELOS — COMPLETE SAAS PLATFORM + HOTEL FOUNTAIN CRM V5.2.0
...
function LandingPage({onSignup, onLogin}) {
  ...
  const features = [
    ...
    {ico:"🎨",title:"Custom Branding",desc:"Your hotel name, logo and brand color. Full white-label — no HotelOS branding shown to guests."},
    {ico:"🔒",title:"Role-Based Access",desc:"Super Admin, Manager, Receptionist, Housekeeping, Accountant — each with scoped permissions."},
  ];

  const testimonials = [
    {name:"Tariq Rahman",role:"GM — Dhaka Grand Hotel",stars:5,text:"We replaced 3 different tools with HotelOS. Reservations, billing, housekeeping — all in one place. Our staff loved the role system."},
  ...
  return (
    <div className="lp">
      ...
      <nav className="lp-nav">
        <div className="lp-nav-logo">HotelOS</div>
      ...
      <section className="hero">
        ...
        <div style={{position:"relative",zIndex:1}}>
          <div className="hero-pill">⚡ Now with full white-label & custom domains</div>
          <h1>The Hotel CRM<br/>Built to <span>Scale</span></h1>
          <p className="hero-sub">One platform for every property — reservations, billing, housekeeping, guest CRM, and reporting. Fully multi-tenant, fully yours.</p>
      ...
      <section className="section" id="features" style={{background:"var(--s1)",borderTop:"1px solid var(--br)"}}>
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          ...
          <p className="section-sub">Designed for real hotel operations — from front desk check-in to GM reports.</p>
      ...
      <section className="section" id="pricing">
        <div style={{maxWidth:1100,margin:"0 auto",textAlign:"center"}}>
          ...
          <p className="section-sub" style={{margin:"0 auto 24px"}}>Start free, upgrade when you're ready.</p>
      ...
      <section style={{padding:"60px 20px",background:"linear-gradient(135deg,rgba(200,169,110,.08),rgba(200,169,110,.03))",borderTop:"1px solid rgba(200,169,110,.15)",borderBottom:"1px solid rgba(200,169,110,.15)",textAlign:"center"}}>
        <div className="fraktur" style={{fontSize:"clamp(28px,4vw,44px)",color:"var(--gold)",marginBottom:14}}>Start managing smarter today</div>
        <p style={{color:"var(--tx2)",fontSize:15,marginBottom:28}}>14-day free trial. No credit card. Full access.</p>
        <button className="btn btn-gold btn-xl" onClick={onSignup}>Create Your Hotel CRM →</button>
      </section>

      {/* FOOTER */}
      <footer className="footer">
        <div className="fraktur" style={{fontSize:22,color:"var(--gold)"}}>HotelOS</div>
        <div style={{fontSize:12,color:"var(--tx2)"}}>© 2026 HotelOS. All rights reserved.</div>
  ...
  return (
    <div className="auth-bg">
      ...
      <div className="auth-card">
        <div className="auth-logo">HotelOS</div>
        <div className="auth-sub">Create Your Hotel CRM</div>
          ...
          <>
            ...
            <div className="fg">
              ...
              <div style={{display:"flex",alignItems:"center",background:"var(--s2)",border:"1px solid var(--br2)",borderRadius:7,overflow:"hidden"}}>
                <span style={{padding:"0 10px",fontFamily:"'Helvetica Light',Helvetica,Arial,sans-serif",fontSize:11,color:"var(--tx3)",borderRight:"1px solid var(--br2)",whiteSpace:"nowrap"}}>hotelos.app/</span>
        ...
        {step===3&&(
          <div className="plan-grid">
            ...
            <div style={{fontSize:11.5,color:"var(--grn)",textAlign:"center",padding:"6px 0",fontFamily:"'Helvetica Light',Helvetica,Arial,sans-serif"}}>✓ 14-day free trial · No credit card required</div>
          </div>
        )}
        ...
        <button className="btn btn-gold w100 btn-xl" style={{justifyContent:"center",marginTop:4}} disabled={loading} onClick={next}>
          {loading?"Creating your CRM…":step<3?"Continue →":"Launch My Hotel CRM 🚀"}
        </button>
        ...
        <div className="preview-banner" style={{background:`rgba(${parseInt(color.slice(1,3),16)},${parseInt(color.slice(3,5),16)},${parseInt(color.slice(5,7),16)},0.12)`,border:`1px solid ${color}30`}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            ...
            <div>
              ...
              <div style={{fontFamily:"'Helvetica Light',Helvetica,Arial,sans-serif",fontSize:9,color:"var(--tx3)",letterSpacing:".1em"}}>POWERED BY HOTELOS · {currency}</div>
            </div>
          </div>
        </div>
...
function SaaSLogin({onLogin, onSignupClick}) {
  ...
  return (
    <div className="auth-bg">
      ...
      <div className="auth-card">
        <div className="auth-logo">HotelOS</div>
        <div className="auth-sub">Sign in to your hotel CRM</div>
...
function SaaSDashboard({tenant, onLogout}) {
  ...
  const nav = [
    {id:"crm",     ico:"🏨", label:"Hotel CRM",    section:"WORKSPACE"},
    ...
    <div className="saas-app">
      ...
      <aside className="saas-sidebar">
        <div className="s-logo" style={{borderBottom:`1px solid ${tenant.brandColor}22`}}>
          ...
          <div className="s-logo-ver">HOTELOS · {PLANS[tenant.plan]?.name?.toUpperCase()}</div>
        </div>
      ...
      <main className="saas-main">
        <div className="topbar">
          <div className="tb-title" style={{color:tenant.brandColor||"var(--gold)"}}>{page==="crm"?"Hotel CRM":page==="dash"?"Overview":page==="billing"?"Billing":page==="settings"?"Settings":""}</div>
    ...
    <div style={{maxWidth:820}}>
      <div className="sub-hero">
        <div className="flex fac fjb" style={{flexWrap:"wrap",gap:12}}>
          <div>
            ...
            <div style={{fontSize:12,color:"var(--tx2)"}}>hotelos.app/{tenant.slug} · Plan: <strong style={{color:plan?.color}}>{plan?.name}</strong></div>
          </div>
      ...
      <div className="card">
        ...
        <div className="card-body" style={{display:"flex",gap:10,flexWrap:"wrap"}}>
          <button className="btn btn-gold" onClick={()=>setPage("crm")}>🏨 Open Hotel CRM</button>
        ...
        <div className="card-body">
          {tenant.plan==="starter"?(
            ...
            <>
              ...
              <div style={{fontSize:11.5,color:"var(--tx3)",marginBottom:10}}>Add a CNAME record: <span className="mono" style={{color:"var(--gold)"}}>crm.{tenant.slug}.hotelos.app</span></div>
        ...
        <div className="modal-bg" onClick={()=>setShowReportModal(false)}>
          <div className="modal modal-wide" style={{maxWidth:820,maxHeight:"92vh"}} onClick={e=>e.stopPropagation()}>
            <div className="modal-hd" style={{background:"#0C1118"}}>
              <div>
                <div className="modal-title" style={{fontFamily:"'Helvetica Rounded Bold','Helvetica Neue',Helvetica,sans-serif",fontSize:20}}>🏨 Hotel Fountain — Daily Report</div>
...
// ────────────────────────────────────────────────────────────────────────
// CRM APP — full Hotel Fountain embedded in SaaS shell
// ────────────────────────────────────────────────────────────────────────
function CRMApp({tenant, toast}) {
  ...
  const hotelName  = tenant?.hotelName  || "Hotel Fountain";
