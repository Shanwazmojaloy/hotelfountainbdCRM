...
function Toast({msg,type,onDone}) {
  ...
  return <div class={`toast${type==='error'?' err':type==='info'?' inf':''}`}>{type==='error'?'⚠ ':'✓ '}{msg}</div>
}

function Av({name,size=32}) {
  return <div class="av" style={{width:size,height:size,fontSize:size*.33,background:`linear-gradient(135deg,${avColor(name)},rgba(0,0,0,.4))`,color:'#EEE9E2'}}>{initials(name)}</div>
}
...
function SBadge({status}) {
  ...
  return <span class={`badge ${m[status]||'bgold'}`}>{String(status).replace(/_/g,' ')}</span>
}
...
function Modal({title,onClose,children,footer,wide}) {
  ...
  return (
    <div class="modal-bg" onClick={onClose}>
      <div class={`modal${wide?' modal-w':''}`} onClick={e=>e.stopPropagation()}>
        <div class="modal-hd">
...
function BarChart({data,active,onHover}) {
  ...
  return (
    <div class="bar-chart" ref={bcRef}>
      {data.map((d,i)=>(
        <div key={i} class="bar-col" onMouseEnter={()=>onHover(i)} title={`${d.ds}: ${BDT(d.v)}`}>
          <div class="bar-fill" style={{height:`${Math.max(3,(d.v/max)*76)}px`,background:i===active?'var(--gold)':'rgba(200,169,110,.28)'}}/>
          <span class="bar-lbl">{d.d}</span>
        </div>
      ))}
    </div>
  )
...
function LoginPage({onLogin, staffList}) {
  ...
  return (
    <div class="login-bg">
      {/* ── LEFT PANEL ── */}
      <div class="lp-left">
        <div class="lp-left-grain"/>
        <div class="lp-bar top">
          <div class="lp-rule"/>
          <div class="lp-label">Staff Portal · {_HNAME}</div>
          <div class="lp-rule dim"/>
        </div>
        <div class="lp-logo-wrap">
          <img src="data:image/png;base64," alt={_HNAME} class="lp-logo-img"/>
          <div class="lp-brand-sub">Management CRM · Powered by Lumea</div>
          <div class="lp-logo-line"/>
        </div>
        <div class="lp-features">
          {[['Room Matrix','Live availability & status grid'],['Guest Ledger','Automated billing in BDT'],['Reservation Engine','Full booking lifecycle']].map(([t,d])=>(
            <div key={t} class="lp-feat">
              <div class="lp-feat-bullet"/>
              <div class="lp-feat-text"><div class="lp-feat-title">{t}</div><div class="lp-feat-desc">{d}</div></div>
            </div>
          ))}
        </div>
        <div class="lp-bar bot">
          <div class="lp-rule dim"/>
          <div class="lp-label">Lumea · The Pulse of Modern Hospitality</div>
          <div class="lp-rule"/>
        </div>
      </div>
      ...
      {/* ── RIGHT PANEL ── */}
      <div class="lp-right">
        <div class="lp-vdivide"/>
        <div class="lp-right-top">
          <span class="lp-right-meta">Secure Staff Portal</span>
          <span class="lp-right-ver">v2.5.0</span>
        </div>
        ...
        <div class="login-card">
          <div class="lc-inner-top"/>

          {/* ════════════ SIGN IN MODE ════════════ */}
          {mode==='signin'&&(
            <form onSubmit={e=>{e.preventDefault();doLogin()}} autoComplete="off" data-form-type="other">
              <div class="lc-signin-label">Sign In</div>
              <div class="lc-ornament">◆ · ◆ · ◆</div>
              <div class="fg" style={{marginBottom:16}}>
                <label class="flbl">Email</label>
                <input class="finput" type="email" value={email}
              ...
              <div class="fg" style={{marginBottom:8}}>
              ...
              {err&&<div class="lc-error">{err}</div>}
              <button class="btn btn-gold w100 login-card"
                ...
                {busy?React.createElement(React.Fragment,null,<span class="spinner" style={{width:12,height:12,border:'1.5px solid rgba(249,247,242,.2)',borderTopColor:'#F9F7F2'}}/>{' '}Signing in…):'SIGN IN →'}
              </button>
          ...
          {mode==='activate'&&(
            <div>
              <div class="lc-signin-label">Activate Account</div>
              <div class="lc-ornament">◆ · ◆ · ◆</div>
              ...
              {actStep===1&&(
                <div>
                  ...
                  <div class="fg" style={{marginBottom:10}}>
                    <label class="flbl">Work Email</label>
                    <input class="finput" type="email" value={actEmail}
                      onChange={e=>{setActEmail(e.target.value);setActErr('')}}
                      placeholder="your@email.com" autoComplete="off"/>
                  </div>
                  {actErr&&<div class="lc-error">{actErr}</div>}
                  <button class="btn btn-gold w100"
                    style={{justifyContent:'center',padding:'14px',fontSize:10,letterSpacing:'.22em',marginTop:10,borderRadius:3,background:'#2D2A26',color:'#F9F7F2',border:'none'}}
                    disabled={actBusy} onClick={doRequestOtp}>
                    {actBusy?React.createElement(React.Fragment,null,<span class="spinner" style={{width:12,height:12,border:'1.5px solid rgba(249,247,242,.2)',borderTopColor:'#F9F7F2'}}/>{' '}Sending…):'SEND CODE →'}
                  </button>
                </div>
              )}
              ...
              {actStep===2&&(
                <div>
                  ...
                  <div class="fg" style={{marginBottom:10}}>
                    <label class="flbl">Verification Code (5 digits)</label>
                    <input class="finput" type="text" maxLength={5} value={actOtp}
                  ...
                  <div class="fg" style={{marginBottom:10}}>
                    <label class="flbl">Set New Password</label>
                    <div style={{position:'relative'}}>
                      <input class="finput" type={actShowPw?'text':'password'} value={actPw}
                  ...
                  <div class="fg" style={{marginBottom:10}}>
                    ...
                    <input class="finput" type="password" value={actPw2}
                  ...
                  <button class="btn btn-gold w100"
                    ...
                    {actBusy?React.createElement(React.Fragment,null,<span class="spinner" style={{width:12,height:12,border:'1.5px solid rgba(249,247,242,.2)',borderTopColor:'#F9F7F2'}}/>{' '}Activating…):'ACTIVATE ACCOUNT →'}
                  </button>
        ...
        <div class="lp-right-bot">Lumea · {_HNAME} Management CRM</div>
      </div>
    </div>
  )
}
    ...
    <div>
      <div class="stats-row">
        {[
          ...
          <div key={s.lbl} class="stat" style={{'--ac':s.ac}}>
            <div class="stat-ico">{s.ico}</div><div class="stat-lbl">{s.lbl}</div>
            <div class="stat-val">{s.val}</div><div class="stat-sub">{s.sub}</div>
          </div>
        ))}
      </div>
      <div class="g2 mb4">
        <div class="card">
          <div class="card-hd">
            ...
            <span class="badge bgold">{last14[chartActive]?.ds?.slice(5)} · {BDT(last14[chartActive]?.v)}</span>
          </div>
          <div class="card-body"><BarChart data={last14} active={chartActive} onHover={setChartActive}/></div>
        </div>
        <div class="card">
          <div class="card-hd"><span class="card-title">Room Status Overview</span></div>
          <div class="card-body">
            {[['AVAILABLE','grn'],['OCCUPIED','sky'],['DIRTY','amb'],['OUT_OF_ORDER','rose'],['RESERVED','pur']].map(([s,c])=>{
              const cnt=rooms.filter(r=>r.status===s).length
              return (
                <div key={s} class="flex fac fjb" style={{padding:'5px 0',borderBottom:'1px solid var(--br2)'}}>
                  <div class="flex fac gap2"><span class={`rdot ${s}`}/><span class="xs">{s.replace('_',' ')}</span></div>
                  <div class="flex fac gap2">
                    <span class="xs gold">{cnt}</span>
      ...
      <div class="g2">
        <div class="card">
          <div class="card-hd">
            <span class="card-title">Currently In-House</span>
            <button class="btn btn-ghost btn-sm" onClick={()=>setPage('reservations')}>View All →</button>
          </div>
          <div class="card-body" style={{padding:'6px 13px'}}>
            {checkedIn.length===0
              ?<div style={{padding:'18px 0',textAlign:'center',color:'var(--tx3)',fontSize:12}}>No active check-ins</div>
              :checkedIn.map(r=>(
                <div key={r.id} class="flex fac gap2" style={{padding:'8px 0',borderBottom:'1px solid var(--br2)'}}>
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    ...
                    <div class="xs muted">Rm {(r.room_ids||[]).join(',')} · Out: {fmtDate(r.check_out)}</div>
                  </div>
                  <span class="badge bb">{BDT(r.total_amount)}</span>
                </div>
              ))
            }
          </div>
        ...
        <div class="card">
          <div class="card-hd">
            ...
            <button class="btn btn-ghost btn-sm" onClick={()=>setPage('billing')}>View All →</button>
          </div>
          <div class="card-body" style={{padding:'6px 13px'}}>
            {mergedTransactions.slice(0,8).map(t=>(
              <div key={t.id} class="flex fac fjb" style={{padding:'6px 0',borderBottom:'1px solid var(--br2)'}}>
                <div style={{flex:1,minWidth:0}}>
                  <div class="xs" style={{whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'}}>{t.guest_name||'—'}</div>
                  <div class="xs muted">Rm {t.room_number||'?'} · {t.type||'Payment'}</div>
                </div>
                <span class="xs gold">{BDT(t.amount)}</span>
              </div>
            ))}
          </div>
        </div>
...
function RoomsPage({rooms,guests,reservations,toast,currentUser,reload,businessDate}) {
  ...
  return (
    <div>
      <div class="flex fac fjb mb4" style={{flexWrap:'wrap',gap:8}}>
        <div class="tabs" style={{marginBottom:0}}>
          {['ALL','AVAILABLE','OCCUPIED','DIRTY','OUT_OF_ORDER','RESERVED'].map(s=>(
            <button key={s} class={`tab${filter===s?' on':''}`} onClick={()=>setFilter(s)}>
              {s==='ALL'?`All (${rooms.length})`:`${s.replace('_',' ')} (${sc[s]||0})`}
            </button>
          ))}
        </div>
        {isSA&&<button class="btn btn-gold" onClick={()=>setShowAdd(true)}>+ Add Room</button>}
      </div>
      <div class="flex fac gap3 mb4" style={{flexWrap:'wrap'}}>
        {[['AVAILABLE','grn'],['OCCUPIED','sky'],['DIRTY','amb'],['OUT_OF_ORDER','rose'],['RESERVED','pur']].map(([s])=>(
          <span key={s} class="flex fac xs muted"><span class={`rdot ${s}`}/>{s.replace('_',' ')}</span>
        ))}
        <span class="xs muted" style={{marginLeft:4}}>· Click room to open folio/billing</span>
      </div>
      <div class="rooms-grid">
        {filtered.map(room=>(
          <div key={room.id} class={`room-card ${room.status}`} onClick={()=>setSelRoom(room)}>
            ...
            <div class="flex fac" style={{marginBottom:4}}><span class={`rdot ${room.status}`}/><span class="room-cat">{room.status.replace('_',' ')}</span></div>
            <div class="room-cat">{room.category||'Standard'}</div>
            <div class="room-price">{BDT(room.price)}/night</div>
          </div>
        ))}
      </div>
      {selRoom&&(
...
function RoomModal({room,guests,reservations,rooms,canEdit,canHKStatus,isSA,toast,onClose,reload,businessDate}) {
  ...
  return (
    <Modal title={`Room ${room.room_number} — ${room.category||'Standard'}`} onClose={onClose} wide={!!activeRes}
      footer={
        <div class="flex gap2" style={{flexWrap:'wrap',width:'100%'}}>
          {activeRes&&canEdit&&(
            React.createElement(React.Fragment,null,
              <button class="btn btn-info btn-sm" onClick={()=>setShowCharge(true)}>+ Add Charge</button>
              <button class="btn btn-danger btn-sm" onClick={()=>setShowCO(true)}>🚪 Check Out</button>
            )
          )}
          <div style={{flex:1}}/>
          {(canEdit||canHKStatus)&&<button class="btn btn-gold btn-sm" disabled={saving||(!canEdit&&canHKStatus&&room.status!=='DIRTY')} onClick={saveStatus}>{saving?'Saving…':'Save Status'}</button>}
      ...
      {activeRes&&guest&&(
        <div style={{background:'linear-gradient(135deg,rgba(88,166,255,.07),rgba(200,169,110,.05))',border:'1px solid rgba(200,169,110,.18)',borderRadius:9,padding:'12px 14px',marginBottom:14}}>
          <div class="flex fac fjb" style={{flexWrap:'wrap',gap:8}}>
            <div class="flex fac gap3">
              <Av name={guest.name} size={40}/>
              <div>
                <div style={{fontWeight:700,fontSize:16}}>{guest.name}</div>
                <div class="xs muted">Room {room.room_number} · {fmtDate(activeRes.check_in)} → {fmtDate(activeRes.check_out)}</div>
                <div class="xs" style={{color:'var(--amb)',marginTop:2}}>{nights} night{nights!==1?'s':''} · {BDT(roomRate)}/night</div>
              </div>
            </div>
            <div style={{textAlign:'right'}}>
              <div class="xs muted">Balance Due</div>
      ...
      {activeRes&&(
        <div style={{background:'var(--s2)',borderRadius:8,border:'1px solid var(--br2)',overflow:'hidden',marginBottom:14}}>
          <div style={{padding:'7px 12px',background:'rgba(200,169,110,.04)',borderBottom:'1px solid var(--br2)',fontSize:8,letterSpacing:'.1em',color:'var(--tx2)',textTransform:'uppercase',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
            ...
            {canEdit&&!canHKStatus&&<button class="btn btn-ghost btn-sm" style={{fontSize:10}} onClick={()=>setShowCharge(true)}>+ Add</button>}
          </div>
          <div style={{padding:'0 12px'}}>
            {fLoad&&<div class="xs muted" style={{padding:'12px 0',textAlign:'center'}}>Loading folio…</div>}
            {!fLoad&&chargeFolios.length===0&&nights===0&&<div class="xs muted" style={{padding:'12px 0',textAlign:'center'}}>No extra charges</div>}
            {/* Room charge line */}
            {!fLoad&&nights>0&&(
              <div class="folio-row">
                <div><span>Room charge</span> <span class="badge bgold" style={{fontSize:8,marginLeft:6}}>{nights}×{BDT(roomRate)}</span></div>
                <span class="xs gold">{BDT(roomCharge)}</span>
              </div>
            )}
            {chargeFolios.map(f=>(
              <div key={f.id} class="folio-row">
                <div><span>{f.description}</span><span class="badge bgold" style={{marginLeft:6,fontSize:8}}>{f.category}</span></div>
                <div class="flex fac gap2">
                  <span class="xs gold">{BDT(f.amount)}</span>
          ...
          <div style={{padding:'9px 12px',background:'rgba(200,169,110,.03)',borderTop:'1px solid var(--br2)'}}>
            <div class="flex fjb xs muted" style={{marginBottom:3}}><span>Subtotal</span><span>{BDT(sub)}</span></div>
            {discount>0&&<div class="flex fjb xs" style={{marginBottom:3,color:'var(--grn)'}}><span>Discount{isMulti?' (prorated)':''}</span><span>- {BDT(discount)}</span></div>}
            <div class="divider" style={{margin:'6px 0'}}/>
            <div class="flex fjb xs" style={{marginBottom:3,fontWeight:600}}><span>Total</span><span>{BDT(total)}</span></div>
            <div class="flex fjb xs" style={{marginBottom:3,color:'var(--grn)'}}><span>Paid{isMulti?' (prorated)':''}</span><span>- {BDT(paid)}</span></div>
            <div class="divider" style={{margin:'6px 0'}}/>
            <div class="flex fjb" style={{fontSize:13,fontWeight:700,color:due>0?'var(--rose)':'var(--grn)'}}><span>Balance Due</span><span>{BDT(due)}</span></div>
          </div>
        </div>
      )}
      ...
      {activeRes&&canEdit&&(
        <div style={{background:'rgba(200,169,110,.06)',border:'1px solid var(--br)',padding:'12px 14px',marginBottom:14}}>
          <div class="flbl" style={{marginBottom:8}}>💰 Collect Payment</div>
          <div style={{display:'flex',gap:8,alignItems:'center'}}>
            <input type="number" class="finput" value={collectAmt}
              onChange={e=>setCollectAmt(e.target.value)}
              placeholder={`Due: ${BDT(Math.max(0,total-(+activeRes.paid_amount||0)))}`}
              style={{flex:1}}/>
            <button class="btn btn-gold" disabled={collectSaving} onClick={saveCollectAmount} style={{whiteSpace:'nowrap'}}>
              {collectSaving?'Saving…':'Save Payment'}
            </button>
          </div>
          {(+activeRes.paid_amount||0)>0&&(
            <div class="xs muted" style={{marginTop:6}}>Already paid: {BDT(activeRes.paid_amount)} · Balance: {BDT(Math.max(0,total-(+activeRes.paid_amount||0)))}</div>
          )}
        </div>
      )}
      ...
      <div class="g2 mb4">
        {[['Category',room.category||'Standard'],['Rate/Night',BDT(room.price)],['Floor',room.floor||room.room_number.slice(0,-2)||'—'],['Beds',room.beds||'Double']].map(([l,v])=>(
          <div key={l} class="info-box"><div class="info-lbl">{l}</div><div class="info-val">{v}</div></div>
        ))}
      </div>

      {(canEdit||canHKStatus)&&(
        <div class="fg">
          <label class="flbl">Change Status</label>
          {canHKStatus&&!canEdit?(
            room.status==='DIRTY'?(
              <select class="fselect" value={status} onChange={e=>setStatus(e.target.value)}>
                <option value="DIRTY">DIRTY</option>
                <option value="AVAILABLE">AVAILABLE — Mark as Clean</option>
              </select>
            ):<div class="finput" style={{opacity:.5,cursor:'not-allowed'}}>{room.status} — No changes allowed</div>
          ):(
            <select class="fselect" value={status} onChange={e=>setStatus(e.target.value)}>
      ...
      {showCO&&(
        <Modal title="Confirm Guest Checkout" onClose={()=>setShowCO(false)}
          footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={()=>setShowCO(false)}>Cancel</button><button class="btn btn-danger" onClick={()=>{doCheckout();setShowCO(false)}}>✓ Confirm Checkout</button>)}>
          <div style={{textAlign:'center',padding:'8px 0 12px'}}>
            <div style={{fontSize:32,marginBottom:10}}>🚪</div>
            <div style={{fontWeight:700,fontSize:17,marginBottom:4}}>{guest?.name||'Guest'}</div>
            <div class="xs muted" style={{marginBottom:12}}>Room {room.room_number} · {nights} night{nights!==1?'s':''}</div>
            {[['Total Bill',BDT(total)],['Paid',BDT(paid)]].map(([l,v])=>(
              <div key={l} class="flex fjb xs muted" style={{maxWidth:240,margin:'3px auto'}}><span>{l}</span><span>{v}</span></div>
            ))}
            <div class="divider" style={{maxWidth:240,margin:'8px auto'}}/>
            <div class="flex fjb" style={{maxWidth:240,margin:'4px auto',fontSize:13,fontWeight:700,color:due>0?'var(--rose)':'var(--grn)'}}>
              <span>{due>0?'Outstanding Due':'Balance'}</span><span>{BDT(due)}</span>
            </div>
            {due>0
              ? <div class="xs" style={{color:'var(--rose)',marginTop:10,maxWidth:280,margin:'10px auto 0'}}>⚠ {BDT(due)} will be carried forward as Outstanding Due. No payment will be auto-posted.</div>
              : <div class="xs" style={{color:'var(--grn)',marginTop:10}}>✓ Folio fully settled</div>}
            <div class="xs muted mt3">Room will move to Dirty / Housekeeping</div>
          </div>
        </Modal>
      )}
    </Modal>
...
function AddChargeModal({roomNo,resId,toast,onClose,onDone}) {
  ...
  return (
    <Modal title={`Add Charge — Room ${roomNo}`} onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>{saving?'Adding…':'Add Charge'}</button>)}>
      <div class="fg">
        <label class="flbl">Category</label>
        <select class="fselect" value={cat} onChange={e=>setCat(e.target.value)}>
          {['Room Charge','Room Service','Restaurant','Spa','Minibar','Laundry','Parking','Airport Transfer','Phone','Misc'].map(c=><option key={c}>{c}</option>)}
        </select>
      </div>
      <div class="fg"><label class="flbl">Amount (BDT) *</label><input type="number" class="finput" value={amt} onChange={e=>setAmt(e.target.value)} placeholder="0" autoFocus/></div>
      <div class="fg"><label class="flbl">Description</label><input class="finput" value={desc} onChange={e=>setDesc(e.target.value)} placeholder="Optional detail"/></div>
    </Modal>
  )
}
...
function AddRoomModal({toast,onClose,reload,rooms}) {
  ...
  return (
    <Modal title="Add New Room" onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>Add Room</button>)}>
      <div class="frow">
        <div class="fg"><label class="flbl">Room Number *</label><input class="finput" value={f.room_number} onChange={F('room_number')} placeholder="e.g. 601" autoFocus/></div>
        <div class="fg"><label class="flbl">Category</label>
          <select class="fselect" value={f.category} onChange={F('category')}>
            {['Fountain Deluxe','Premium Deluxe','Superior Deluxe','Twin Deluxe','Royal Suite'].map(c=><option key={c}>{c}</option>)}
          </select>
        </div>
      </div>
      <div class="frow">
        <div class="fg"><label class="flbl">Rate (BDT/night)</label><input type="number" class="finput" value={f.price} onChange={F('price')}/></div>
        <div class="fg"><label class="flbl">Initial Status</label>
          <select class="fselect" value={f.status} onChange={F('status')}>
      ...
      <div class="flex fac fjb mb4" style={{flexWrap:'wrap',gap:8}}>
        <div class="tabs" style={{marginBottom:0}}>
          {['ALL','CHECKED_IN','RESERVED','PENDING','CHECKED_OUT','DUE','CANCELLED'].map(s=>(
            <button key={s} class={`tab${filter===s?' on':''}`} onClick={()=>setFilter(s)} style={s==='DUE'&&filter!==s?{color:'var(--rose)'}:{}}>
              {s==='ALL'?`All (${reservations.length})`:s==='DUE'?`Due (${dueCount})`:`${s.replace('_',' ')} (${sc[s]||0})`}
            </button>
          ))}
        </div>
        <div class="flex gap2">
          <div class="srch"><span class="xs muted">⌕</span><input placeholder="Search guest, room…" value={search} onChange={e=>setSearch(e.target.value)}/></div>
          <button class="btn btn-gold" onClick={()=>setShowNew(true)}>+ New Reservation</button>
        </div>
      </div>
          ...
          <table class="tbl">
            ...
            <tbody>
              {res.slice(0,80).map(r=>{
                ...
                return (
                  <tr key={r.id}>
                    <td><div class="flex fac gap2"><Av name={gn} size={24}/><span>{gn}</span></div></td>
                    <td><span class="badge bb">{(r.room_ids||[]).join(', ')}</span></td>
                    <td class="xs muted">{fmtDate(r.check_in)}</td>
                    <td class="xs muted">{fmtDate(r.check_out)}</td>
                    <td class="xs gold">{nights||'—'}</td>
                    <td class="xs gold">{BDT(r.total_amount)}</td>
                    <td class="xs" style={{color:'var(--amb)'}}>{(+r.discount_amount||+r.discount||0)>0?'− '+BDT(+r.discount_amount||+r.discount||0):'—'}</td>
                    <td class="xs" style={{color:+r.paid_amount>0?'var(--grn)':'var(--tx2)'}}>{BDT(r.paid_amount)}</td>
                    <td class="xs" style={{color:balance>0?'var(--rose)':'var(--grn)'}}>{BDT(balance)}</td>
                    <td><SBadge status={r.status}/></td>
                    <td><button class="btn btn-ghost btn-sm" onClick={()=>setSelRes(r)}>View</button></td>
                  </tr>
                )
              })}
            </tbody>
  ...
  return (
      ...
      footer={
        <div class="flex gap2" style={{flexWrap:'wrap',width:'100%'}}>
          {(res.status==='RESERVED'||res.status==='PENDING')&&(
            <button class="btn btn-success" disabled={saving} onClick={checkIn}>✓ Check In Now</button>
          )}
          {isOwner&&<button class="btn btn-danger btn-sm" onClick={async()=>{
    ...
    try{
      ...
      reload()
          ...
          <button class="btn btn-gold" disabled={saving} onClick={save}>{saving?'Saving…':'Save Changes'}</button>
        </div>
      }>
      <div class="g2 mb4">
        <div class="info-box"><div class="info-lbl">Guest</div><div class="info-val">{gn}</div></div>
        <div class="info-box" style={{gridColumn:'span 2'}}>
          <div class="info-lbl">Rooms (editable · multi)</div>
          <div style={{marginTop:4}}>
            {roomArr.map((rn,idx)=>(
              <div key={idx} style={{display:'flex',gap:6,marginBottom:4,alignItems:'center'}}>
                <select class="fselect" style={{flex:1,fontSize:12,padding:'4px 8px'}} value={rn} onChange={e=>{const a=[...roomArr];a[idx]=e.target.value;setRoomArr(a)}}>
        ...
        <div class="info-box">
          ...
          <input type="date" class="finput" style={{marginTop:4,fontSize:12,padding:'4px 8px'}} value={checkInDate}
            onChange={e=>setCheckInDate(e.target.value)}/>
        </div>
        <div class="info-box">
          <div class="info-lbl">Check-Out</div>
          <input type="date" class="finput" style={{marginTop:4,fontSize:12,padding:'4px 8px'}} value={checkOut}
            onChange={e=>setCheckOut(e.target.value)} min={checkInDate}/>
        </div>
        <div class="info-box"><div class="info-lbl">Nights</div><div class="info-val">{nights||'—'}</div></div>
        <div class="info-box"><div class="info-lbl">Total Amount</div><div class="info-val">{BDT(totalAmt)}</div></div>
        <div class="info-box"><div class="info-lbl">Payment Method</div><div class="info-val">{res.payment_method||'—'}</div></div>
        <div class="info-box"><div class="info-lbl">On-Duty Officer</div><div class="info-val">{res.on_duty_officer||'—'}</div></div>
      </div>
      {res.special_requests&&<div class="info-box mb4"><div class="info-lbl">Special Requests</div><div class="info-val" style={{marginTop:4}}>{res.special_requests}</div></div>}
      ...
      {(res.status==='CHECKED_IN')&&(
        <div style={{background:'rgba(200,169,110,.06)',border:'1px solid rgba(200,169,110,.2)',padding:'10px 14px',marginBottom:12,display:'flex',alignItems:'center',gap:12,flexWrap:'wrap'}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:8}}>
            ...
            <input type="date" class="finput" value={checkOut} onChange={e=>setCheckOut(e.target.value)} min={String(res.check_in||'').slice(0,10)} style={{width:150,padding:'4px 8px',fontSize:12}}/>
          </div>
      ...
      <div class="frow">
        ...
        <div class="fg">
          <label class="flbl">Amount Paid (BDT)</label>
          <input type="number" class="finput" value={paidAmt} onChange={e=>setPaidAmt(e.target.value)} min="0"/>
          <div class="xs mt3" style={{color:balance>0?'var(--rose)':'var(--grn)'}}>
      ...
      <div class="frow">
        <div class="fg">
          ...
          <input type="number" class="finput" value={discountAmt} onChange={e=>setDiscountAmt(e.target.value)} min="0" placeholder="0"/>
        </div>
        <div class="fg"/>
      </div>
      <div class="fg">
        <label class="flbl">Notes</label>
        <textarea class="ftextarea" value={notes} onChange={e=>setNotes(e.target.value)} style={{minHeight:50}} placeholder="Internal notes…"/>
      </div>
...
function NewReservationModal({guests,rooms,toast,onClose,reload,businessDate}) {
  ...
  return (
    <Modal title="New Reservation / Check-In" onClose={onClose} wide
      footer={
        React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button>
        <button class="btn btn-gold" disabled={saving} onClick={save}>
          {saving?React.createElement(React.Fragment,null,<span class="spinner" style={{width:12,height:12}}/> Saving…):f.stayType==='CHECK_IN'?'✓ Check In Now':'Create Reservation'}
        </button>)
      }>
      <div class="tabs" style={{marginBottom:14}}>
        {[['CHECK_IN','✓ Direct Check-In'],['RESERVATION','📅 Future Reservation']].map(([v,l])=>(
          <button key={v} class={`tab${f.stayType===v?' on':''}`} onClick={()=>setF(p=>({...p,stayType:v}))}>{l}</button>
        ))}
      </div>
      <div class="frow">
        <div class="fg">
          <label class="flbl">Guest * — type name or phone to search</label>
          <GuestSearchInput guests={guests} value={f.guestId} onChange={id=>setF(p=>({...p,guestId:id}))}/>
        </div>
        <div class="fg">
          <label class="flbl">Room(s) * {loadingRooms?<span style={{color:'var(--gold)',fontSize:10}}> Checking availability…</span>:availableRooms.length===0&&<span style={{color:'var(--rose)'}}>— no available rooms</span>}</label>
          {f.roomNos.map((rn,idx)=>(
            <div key={idx} style={{display:'flex',gap:6,marginBottom:5,alignItems:'center'}}>
              <select class="fselect" style={{flex:1}} value={rn} onChange={e=>{const a=[...f.roomNos];a[idx]=e.target.value;setF(p=>({...p,roomNos:a}))}}>
                <option value="">— select room —</option>
      ...
      <div class="frow">
        <div class="fg"><label class="flbl">Check-In Date *</label><input type="date" class="finput" value={f.checkIn} onChange={F('checkIn')}/></div>
        <div class="fg"><label class="flbl">Check-Out Date *</label><input type="date" class="finput" value={f.checkOut} onChange={F('checkOut')}/></div>
      </div>
      {autoNights>0&&(
      ...
      <div class="frow">
        <div class="fg"><label class="flbl">Total Amount (BDT)</label><input type="number" class="finput" value={f.total} onChange={F('total')} placeholder={String(autoTotal||0)}/></div>
        <div class="fg"><label class="flbl">Paid Amount (BDT)</label><input type="number" class="finput" value={f.paid} onChange={F('paid')} placeholder="0"/></div>
      </div>
      <div class="frow">
        <div class="fg"><label class="flbl">Discount Amount (BDT)</label><input type="number" class="finput" value={f.discount} onChange={F('discount')} placeholder="0" min="0"/></div>
        <div class="fg"/>
      </div>
      <div class="frow">
        <div class="fg">
          <label class="flbl">Payment Method</label>
          <select class="fselect" value={f.method} onChange={F('method')}>
            {['Cash','Bkash','Nagad','Card','Bank Transfer','Corporate','Complimentary'].map(m=><option key={m}>{m}</option>)}
          </select>
        </div>
        <div class="fg"><label class="flbl">On-Duty Officer</label><input class="finput" value={f.officer} onChange={F('officer')} placeholder="Staff name"/></div>
      </div>
      <div class="fg"><label class="flbl">Special Requests / Notes</label><textarea class="ftextarea" value={f.notes} onChange={F('notes')} style={{minHeight:50}} placeholder="Optional"/></div>
    </Modal>
  )
}
...
function GuestsPage({guests,reservations,toast,currentUser,reload}) {
  ...
  return (
    <div>
      <div class="flex fac fjb mb4" style={{flexWrap:'wrap',gap:8}}>
        <div class="srch"><span class="xs muted">⌕</span><input placeholder="Search name, phone, email…" value={search} onChange={e=>setSearch(e.target.value)}/></div>
        <div class="flex gap2" style={{alignItems:'center'}}>
          <span class="badge bgold">{filtered.length} {search?'found':('of '+guests.length+' guests')}</span>
          <button class="btn btn-gold" onClick={()=>setShowAdd(true)}>+ Add Guest</button>
        </div>
      </div>
      <div class="card">
        <div class="tbl-wrap">
          <table class="tbl">
            ...
            <tbody>
              {pageList.map(g=>(
                <tr key={g.id}>
                  <td><div class="flex fac gap2"><Av name={g.name} size={24}/><span>{g.name}</span></div></td>
                  <td class="xs muted">{g.phone||'—'}</td>
                  <td class="xs muted">{g.email||'—'}</td>
                  <td class="xs muted">{g.id_type?`${g.id_type}: ${g.id_number||''}`:g.id_card||'—'}</td>
                  <td class="xs muted">{g.city||'—'}</td>
                  <td class="xs" style={{color:guestBal(g)>0?'var(--rose)':'var(--grn)'}}>{BDT(guestBal(g))}</td>
                  <td>{g.vip?<span class="badge bgold">VIP</span>:null}</td>
                  <td><button class="btn btn-ghost btn-sm" onClick={()=>setSel(g)}>View</button></td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {totalPages>1&&(
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 4px',flexWrap:'wrap',gap:8}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:4}}>
            <button class="btn btn-ghost btn-sm" disabled={page===1} onClick={()=>setPage(1)} style={{padding:'4px 8px',opacity:page===1?.35:1}}>«</button>
            <button class="btn btn-ghost btn-sm" disabled={page===1} onClick={()=>setPage(p=>p-1)} style={{padding:'4px 10px',opacity:page===1?.35:1}}>‹ Prev</button>
            {/* Page number pills */}
            {Array.from({length:totalPages},(_,i)=>i+1)
              ...
              .map((p,i)=>
                p==='...'
                  ?<span key={'e'+i} class="xs muted" style={{padding:'0 4px'}}>…</span>
                  :<button key={p} class={`btn btn-sm${p===page?' btn-gold':' btn-ghost'}`}
                    style={{padding:'4px 9px',minWidth:30}}
                    onClick={()=>setPage(p)}>{p}</button>
              )
            }
            <button class="btn btn-ghost btn-sm" disabled={page===totalPages} onClick={()=>setPage(p=>p+1)} style={{padding:'4px 10px',opacity:page===totalPages?.35:1}}>Next ›</button>
            <button class="btn btn-ghost btn-sm" disabled={page===totalPages} onClick={()=>setPage(totalPages)} style={{padding:'4px 8px',opacity:page===totalPages?.35:1}}>»</button>
          </div>
        </div>
      )}
...
function GuestModal({guest,reservations,toast,onClose,reload,isSA}) {
  ...
  return (
    ...
    <Modal title={guest.name} onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Close</button>{isSA&&<button class="btn btn-danger btn-sm" onClick={()=>{if(window.confirm('Delete this guest?'))doDelete()}}>🗑 Delete</button>}<button class="btn btn-ghost" onClick={()=>setShowEdit(true)}>✏ Edit</button><button class="btn btn-gold" onClick={toggleVIP}>{guest.vip?'Remove VIP':'★ Mark VIP'}</button>)}>
      <div class="flex fac gap3 mb4">
        <Av name={guest.name} size={44}/>
        <div>
          {guest.vip&&<span class="badge bgold" style={{marginBottom:4,display:'inline-flex'}}>VIP</span>}
          <div style={{fontWeight:700,fontSize:18}}>{guest.name}</div>
          <div class="xs muted">{[guest.nationality,guest.city,guest.country].filter(Boolean).join(' · ')}</div>
        </div>
      </div>
      <div class="g2 mb4">
      ...
      {gRes.length>0&&(
        React.createElement(React.Fragment,null,
          <div class="flbl" style={{marginBottom:6}}>Stay History</div>
          {gRes.map(r=>(
            <div key={r.id} class="flex fac fjb" style={{padding:'6px 0',borderBottom:'1px solid var(--br2)'}}>
              <span class="xs">Rm {(r.room_ids||[]).join(',')} · {fmtDate(r.check_in)} → {fmtDate(r.check_out)}</span>
              <SBadge status={r.status}/>
            </div>
          ))}
        )
      )}
      {guest.preferences&&<div class="info-box mt3"><div class="info-lbl">Preferences</div><div class="info-val" style={{marginTop:4}}>{guest.preferences}</div></div>}
    </Modal>
...
function EditGuestModal({guest,toast,onClose,reload}) {
  ...
  return (
    <Modal title={`Edit — ${guest.name}`} onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>{saving?'Saving…':'Save Changes'}</button>)}>
      <div class="fg"><label class="flbl">Full Name *</label><input class="finput" value={f.name} onChange={F('name')} autoFocus/></div>
      <div class="frow">
        <div class="fg"><label class="flbl">Phone</label><input class="finput" value={f.phone} onChange={F('phone')} placeholder="+880…"/></div>
        <div class="fg"><label class="flbl">Email</label><input type="email" class="finput" value={f.email} onChange={F('email')}/></div>
      </div>
      <div class="frow">
        <div class="fg"><label class="flbl">ID Type</label>
          <select class="fselect" value={f.id_type} onChange={F('id_type')}>
            {['NID','Passport','Driving License','Birth Certificate','Other'].map(t=><option key={t}>{t}</option>)}
          </select>
        </div>
        <div class="fg"><label class="flbl">ID Number</label><input class="finput" value={f.id_number} onChange={F('id_number')}/></div>
      </div>
      <div class="frow">
        <div class="fg"><label class="flbl">Nationality</label><input class="finput" value={f.nationality} onChange={F('nationality')}/></div>
        <div class="fg"><label class="flbl">City</label><input class="finput" value={f.city} onChange={F('city')}/></div>
      </div>
      <div class="fg"><label class="flbl">Address</label><textarea class="ftextarea" value={f.address} onChange={F('address')} style={{minHeight:44}}/></div>
    </Modal>
  )
}
...
function AddGuestModal({toast,onClose,reload}) {
  ...
  return (
    <Modal title="Add New Guest" onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>Add Guest</button>)}>
      <div class="fg"><label class="flbl">Full Name <span style={{color:'var(--rose)'}}>*</span></label><input class="finput" value={f.name} onChange={F('name')} placeholder="Guest full name" autoFocus/></div>
      <div class="frow">
        <div class="fg"><label class="flbl">Contact Number <span style={{color:'var(--rose)'}}>*</span></label><input class="finput" value={f.phone} onChange={F('phone')} placeholder="+880…"/></div>
        <div class="fg"><label class="flbl">Email</label><input type="email" class="finput" value={f.email} onChange={F('email')} placeholder="guest@email.com"/></div>
      </div>
      <div class="frow">
        <div class="fg"><label class="flbl">ID Type</label>
          <select class="fselect" value={f.id_type} onChange={F('id_type')}>
        ...
        <div class="fg"><label class="flbl">ID Number</label><input class="finput" value={f.id_number} onChange={F('id_number')} placeholder="ID number"/></div>
      </div>
      <div class="frow">
        <div class="fg"><label class="flbl">Nationality</label><input class="finput" value={f.nationality} onChange={F('nationality')} placeholder="e.g. Bangladeshi"/></div>
        <div class="fg"><label class="flbl">City</label><input class="finput" value={f.city} onChange={F('city')} placeholder="Dhaka"/></div>
      </div>
      <div class="fg"><label class="flbl">Address</label><textarea class="ftextarea" value={f.address} onChange={F('address')} placeholder="Full address" style={{minHeight:44}}/></div>
    </Modal>
  )
}
      ...
      <div class="flex fac fjb mb4" style={{flexWrap:'wrap',gap:8}}>
        <div class="tabs" style={{marginBottom:0}}>
          {[['ALL','All Tasks'],['pending','Pending'],['in-progress','In Progress'],['completed','Completed'],['DIRTY',`Dirty Rooms (${dirty.length})`]].map(([v,l])=>(
            <button key={v} class={`tab${filter===v?' on':''}`} onClick={()=>setFilter(v)}>{l}</button>
          ))}
        </div>
        <button class="btn btn-gold" onClick={()=>setShowAdd(true)}>+ Add Task</button>
      </div>
      <div class="card">
        <div class="tbl-wrap">
          <table class="tbl">
            ...
            <tbody>
              {list.slice(0,60).map(t=>(
                <tr key={t.id}>
                  ...
                  <td class="sm">{t.task_type}</td>
                  <td><div class="flex fac gap2"><span class={`pdot ${t.priority||'medium'}`}/><span class="xs">{t.priority||'medium'}</span></div></td>
                  <td class="xs muted">{t.assignee||'—'}</td>
                  <td class="xs muted">{t.scheduled_time||'—'}</td>
                  <td class="xs muted" style={{maxWidth:120,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{t.notes||'—'}</td>
                  <td><SBadge status={t.status||'pending'}/></td>
                  <td>
                    <div class="flex gap2">
                    {!t._dirty&&(
                      <select class="fselect" style={{padding:'3px 22px 3px 7px',fontSize:10,minWidth:110}}
                    ...
                    {isSA&&!t._dirty&&<button class="btn btn-danger btn-sm" style={{padding:'3px 8px',fontSize:10}} onClick={async()=>{if(!window.confirm('Delete task?'))return;try{await dbDelete('housekeeping_tasks',t.id);toast('Task deleted');reload()}catch(e){toast(e.message,'error')}}}>✕</button>}
                    </div>
                  </td>
                </tr>
              ))}
...
function AddTaskModal({rooms,toast,onClose,reload}) {
  ...
  return (
    <Modal title="Add Housekeeping Task" onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>Add Task</button>)}>
      <div class="frow">
        <div class="fg"><label class="flbl">Room *</label>
          <select class="fselect" value={f.room_number} onChange={F('room_number')}>
            {rooms.map(r=><option key={r.id} value={r.room_number}>{r.room_number} — {r.status.replace('_',' ')}</option>)}
          </select>
        </div>
        <div class="fg"><label class="flbl">Task Type</label>
          <select class="fselect" value={f.task_type} onChange={F('task_type')}>
      ...
      <div class="frow">
        <div class="fg"><label class="flbl">Priority</label>
          <select class="fselect" value={f.priority} onChange={F('priority')}>
            {['low','medium','high'].map(p=><option key={p} value={p}>{p}</option>)}
          </select>
        </div>
        <div class="fg"><label class="flbl">Scheduled Time</label><input type="time" class="finput" value={f.scheduled_time} onChange={F('scheduled_time')}/></div>
      </div>
      <div class="fg"><label class="flbl">Assignee</label><input class="finput" value={f.assignee} onChange={F('assignee')} placeholder="Staff member name"/></div>
      <div class="fg"><label class="flbl">Notes</label><textarea class="ftextarea" value={f.notes} onChange={F('notes')} placeholder="Optional details" style={{minHeight:44}}/></div>
    </Modal>
  )
}
...
function downloadBillingPDF(enriched, filter, periodTotal, cashTotal, bkashTotal, outstanding, calDate, tokenAmount, duesList) {
  ...
  const esc = s => String(s==null?'':s).replace(/[&React.createElement(React.Fragment,null,"']/g, c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'})[c])
  ...
  return (
    <div>
      ...
      <div class="stats-row" style={{gridTemplateColumns:'repeat(3,1fr)'}}>
        <div class="stat" style={{'--ac':'var(--gold)'}}><div class="stat-ico">💰</div><div class="stat-lbl">{filter==='DATE'&&calDate?(()=>{const [y,m,d]=calDate.split('-');const mo=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];return `${+d}-${mo[+m-1]}-${y}`})():(()=>{const[y,m,d]=(today||todayStr()).split('-');return `${+d}-${['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][+m-1]}-${y}`})()} <span style={{fontSize:9,color:'var(--gold-light)',marginLeft:4,fontFamily:'var(--mono)'}}>BIZ DAY</span></div><div class="stat-val">{BDT(filter==='DATE'?_bizDayTotal(calT):_bizDayTotal(todayT))}</div><div class="stat-sub">{filter==='DATE'?`${calT.filter(_isPayVehicle).length} payments`:`${reservations.filter(r=>r.status==='CHECKED_IN').length} in-house`}</div></div>
        <div class="stat" style={{'--ac':'var(--teal)'}}><div class="stat-ico">📈</div><div class="stat-lbl">This Month</div><div class="stat-val">{BDT(monthRevenue)}</div><div class="stat-sub">{monthT.filter(t=>t.type!=='Balance Carried Forward').length} transactions</div></div>
        <div class="stat" style={{'--ac':'var(--rose)'}}><div class="stat-ico">⚠</div><div class="stat-lbl">Outstanding</div><div class="stat-val">{BDT(outstanding)}</div><div class="stat-sub">In-house balance due</div></div>
      </div>
        ...
        <div style={{display:'flex',alignItems:'center',gap:0}}>
          <div class="tabs" style={{marginBottom:0}}>
            {(()=>{const[y,m,d]=(today||todayStr()).split('-');const lbl=`${+d}-${['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][+m-1]}-${y}`;return[['TODAY',lbl],['MONTH','MONTH'],['ALL','ALL']]})().map(([f,lbl])=>(
              <button key={f} class={`tab${filter===f?' on':''}`} onClick={()=>{setFilter(f);setCalDate('')}}>{lbl}</button>
            ))}
          </div>
          ...
          {currentUser?.role!=='housekeeping'&&(
            <div style={{display:'flex',alignItems:'center',gap:8}}>
              ...
              <div style={{display:'flex',alignItems:'center',gap:6,background:'rgba(200,169,110,.06)',border:'1px solid var(--br)',padding:'4px 10px'}}>
                ...
                <input type="number" class="finput" value={tokenAmt} onChange={e=>setTokenAmt(e.target.value)}
                  placeholder="0" style={{width:90,padding:'4px 8px',fontSize:12}}/>
                <button class="btn btn-ghost btn-sm" style={{padding:'4px 10px',fontSize:9}} disabled={tokenSaving} onClick={saveToken}>
                  {tokenSaving?'…':'Save'}
                </button>
                <button class="btn btn-ghost btn-sm" style={{padding:'4px 10px',fontSize:9,marginLeft:6,borderLeft:'1px solid var(--br)',paddingLeft:10}} onClick={downloadPDF} title="Download specific date report">
                  📥 Download Report
                </button>
              </div>
              {/* Closing Complete */}
              <button class="btn btn-gold btn-sm" style={{gap:5,whiteSpace:'nowrap'}} onClick={doClosingComplete}>
                ✓ Closing Complete
              </button>
            </div>
          )}
      ...
      {(()=>{
        ...
        return (
          <div class="card" style={{marginBottom:12}}>
            <div class="card-hd">
              <span class="card-title" style={{fontSize:14}}>Active Billing Ledger — {label}</span>
              <span class="badge bgold">{displayList.length} records</span>
            </div>
            <div class="tbl-wrap">
              <table class="tbl">
                  ...
                  {displayList.length===0?(
                    ...
                    return (
                      <tr key={r?r.id:(grp.guest_name+'|'+grp.room_number)}>
                        <td class="xs">{gname}</td>
                        <td><span class="badge bb">{rno}</span></td>
                        <td class="xs muted">{chkIn}</td>
                        <td class="xs muted">{chkOut}</td>
                        <td class="xs gold">{BDT(tTotal)}</td>
                        <td class="xs" style={{color:'var(--amb)'}}>{tDiscount>0?'− '+BDT(tDiscount):'—'}</td>
                        <td class="xs" style={{color:'var(--grn)'}}>{BDT(tPaid)}</td>
                        <td class="xs" style={{color:tDue>0?'var(--rose)':'var(--grn)',fontWeight:tDue>0?600:400}}>{BDT(tDue)}</td>
                        <td class="xs" style={{lineHeight:1.8}}>
                          {Object.keys(byType).length === 0 ? <span class="muted xs" style={{fontSize:10}}>— No Pymt in Period —</span> : 
                            Object.entries(byType).map(([tp,amt])=>(
                            <div key={tp} style={{display:'flex',justifyContent:'space-between',gap:12,minWidth:140}}>
                              <span class="badge bgold" style={{fontSize:8}}>{tp}</span>
                        ...
                        <td style={{whiteSpace:'nowrap'}}>
                          {currentUser?.role!=='housekeeping'&&(
                            <button class="btn btn-gold btn-sm" style={{padding:'3px 9px',fontSize:9,marginRight:4}} onClick={()=>{
                          ...
                          {currentUser?.role!=='housekeeping'&&(
                            <button class="btn btn-ghost btn-sm" style={{padding:'3px 9px',fontSize:9,marginRight:4}} onClick={()=>{
                          ...
                          {currentUser?.role!=='housekeeping'&&r&&(
                              <button class="btn btn-ghost btn-sm" style={{padding:'3px 9px',fontSize:9,marginRight:4}} onClick={()=>openDetail(r)}>Detail</button>
                          )}
                          {currentUser?.role==='owner'&&grp.txs.length>0&&(
                            <button class="btn btn-danger btn-sm" style={{padding:'3px 7px',fontSize:9}} onClick={async()=>{
          ...
          <div class="flex fac fjb" style={{flexWrap:'wrap',gap:8}}>
            <div class="flex fac gap3">
              ...
              <div>
                ...
                <div class="xs muted">Room{allRoomNos.length>1?'s':''} {allRoomNos.join(', ')} · {fmtDate(detailRes.check_in)} → {fmtDate(detailRes.check_out)}</div>
                <div class="xs" style={{color:'var(--amb)',marginTop:2}}>{nights} night{nights!==1?'s':''} · {allRoomNos.length} room{allRoomNos.length!==1?'s':''}</div>
              </div>
            </div>
            <div style={{textAlign:'right',display:'flex',flexDirection:'column',alignItems:'flex-end',gap:6}}>
              <div><div class="xs muted">Total Due</div><div style={{fontWeight:700,fontSize:22,color:'var(--gold)'}}>{BDT(due)}</div></div>
              <button class="btn btn-ghost btn-sm" onClick={()=>{setShowBillDetail(false);setDetailRes(null)}}>✕ Close</button>
            </div>
          </div>
          {/* Info grid */}
          <div class="g2 mb4">
          ...
          <div style={{background:'var(--s2)',border:'1px solid var(--br2)',overflow:'hidden',marginBottom:8}}>
            {(perRoom||[]).map((p,i)=>(
              <div key={p.room_number+i} style={{borderBottom:i<perRoom.length-1?'1px solid var(--br2)':'none'}}>
                <div style={{padding:'8px 12px',background:'rgba(200,169,110,.06)',borderBottom:'1px solid var(--br2)',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                  ...
                  <span class="xs" style={{color:'var(--gold)'}}>{nights}×{BDT(p.rate)} = {BDT(p.roomSubtotal)}</span>
                </div>
                {p.folios.length===0&&p.extras===0?<div class="xs muted" style={{padding:'6px 14px'}}>No extras charged to this room</div>
                :p.folios.map(f=>(
                  <div key={f.id} class="folio-row" style={{paddingLeft:20}}>
                    <div><span>{f.description}</span><span class="badge bgold" style={{marginLeft:6,fontSize:8}}>{f.category}</span></div>
                    <span class="xs gold">{BDT(f.amount)}</span>
                  </div>
                ))}
                {p.extras>0&&(
                  <div class="folio-row" style={{paddingLeft:20,background:'rgba(200,169,110,.03)',fontWeight:600}}>
                    <span class="xs muted">Room {p.room_number} subtotal</span>
                    <span class="xs gold">{BDT(p.subtotal)}</span>
                  </div>
                )}
              </div>
            ))}
            {(topFolios||[]).length>0&&(
              <div style={{borderTop:'1px solid var(--br2)'}}>
                ...
                {topFolios.map(f=>(
                  <div key={f.id} class="folio-row">
                    <div><span>{f.description}</span><span class="badge bb" style={{marginLeft:6,fontSize:8}}>{f.category}</span></div>
                    <span class="xs gold">{BDT(f.amount)}</span>
                  </div>
                ))}
              </div>
            ...
            {relTx.map(t=>(
              <div key={t.id} class="folio-row" style={{opacity:.75}}>
                <div><span style={{color:'var(--tx2)'}}>{t.type||'Charge'}</span><span class="badge bb" style={{marginLeft:6,fontSize:8}}>{t.fiscal_day}</span></div>
                <span class="xs" style={{color:'var(--sky)'}}>{BDT(t.amount)}</span>
              </div>
            ))}
          </div>
          <div style={{padding:'9px 12px',background:'rgba(200,169,110,.03)',borderTop:'1px solid var(--br2)'}}>
            {[['Subtotal',sub]].map(([l,v])=>(
              <div key={l} class="flex fjb xs muted" style={{marginBottom:3}}><span>{l}</span><span>{BDT(v)}</span></div>
            ))}
            {discount>0&&<div class="flex fjb xs" style={{marginBottom:3,color:'var(--grn)'}}><span>Discount</span><span>- {BDT(discount)}</span></div>}
            {[[`VAT ${vatPct||15}%`,tax],[`Service Charge ${svcPct||5}%`,svc]].map(([l,v])=>(
              <div key={l} class="flex fjb xs muted" style={{marginBottom:3}}><span>{l}</span><span>{BDT(v)}</span></div>
            ))}
            <div class="divider" style={{margin:'6px 0'}}/>
            <div class="flex fjb" style={{fontSize:13,fontWeight:700,color:'var(--gold)'}}><span>Total</span><span>{BDT(total)}</span></div>
            <div class="flex fjb xs" style={{marginTop:4}}>
...
function RecordPayModal({toast,onClose,reload,prefill,reservations,guests,businessDate}) {
  ...
  return (
    <Modal title="Record Payment" onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>{saving?'Saving…':'Record Payment'}</button>)}>
      ...
      {fromRow&&(
        <div style={{border:'1px solid var(--br)',marginBottom:14,overflow:'hidden'}}>
          ...
          <div style={{background:'rgba(200,169,110,.08)',padding:'10px 14px',display:'flex',justifyContent:'space-between',alignItems:'center',borderBottom:'1px solid var(--br)'}}>
            <div style={{display:'flex',alignItems:'center',gap:8}}>
              <span class="badge bb" style={{padding:'3px 10px',fontSize:11}}>{lockedRoom||'—'}</span>
      ...
      {!fromRow&&(
        <div style={{marginBottom:12,position:'relative'}}>
          <label class="flbl">Guest / Room <span style={{color:'var(--rose)'}}>*</span></label>
          <div style={{display:'flex',gap:6,alignItems:'center'}}>
            <input class="finput" value={resSearch}
                ...
                .map(r=>{
                  ...
                  return(
                    <div key={r.id} onClick={()=>pickRes(r)}
                      ...
                      <div style={{display:'flex',alignItems:'center',gap:8}}>
                        <span class="badge bb">{r.room_number||'—'}</span>
          ...
          {selRes&&(()=>{
            ...
            <div style={{marginTop:6,background:'rgba(200,169,110,.06)',border:'1px solid var(--br)',padding:'8px 12px',fontSize:11,display:'flex',justifyContent:'space-between',flexWrap:'wrap',gap:8}}>
              <span style={{color:'var(--tx2)'}}>
                ...
                {selDisc>0&&React.createElement(React.Fragment,null, · Discount: <strong style={{color:'var(--amb)'}}>− {BDT(selDisc)}</strong>)}
      ...
      <div class="frow">
        <div class="fg">
          ...
          <input type="number" class="finput" value={amount} onChange={e=>setAmount(e.target.value)} placeholder="0" autoFocus={fromRow}/>
        </div>
        <div class="fg">
          <label class="flbl">Date</label>
          <input type="date" class="finput" value={fiscal_day} onChange={e=>setFiscalDay(e.target.value)}/>
        </div>
      </div>

      {/* ── Payment Type ── */}
      <div class="fg">
        <label class="flbl">Payment Type</label>
        <select class="fselect" value={type} onChange={e=>setType(e.target.value)}>
...
function ReportsPage({transactions,rooms,reservations,guests}) {
  ...
  return (
    <div>
      <div class="stats-row">
        <div class="stat" style={{'--ac':'var(--gold)'}}><div class="stat-lbl">Total Revenue</div><div class="stat-val">{BDT(totalRev)}</div></div>
        <div class="stat" style={{'--ac':'var(--sky)'}}><div class="stat-lbl">Occupancy</div><div class="stat-val">{occPct}%</div><div class="stat-sub">{occ}/{rooms.length} rooms</div></div>
        <div class="stat" style={{'--ac':'var(--teal)'}}><div class="stat-lbl">ADR</div><div class="stat-val">{BDT(avgRate)}</div><div class="stat-sub">Avg Daily Rate</div></div>
        <div class="stat" style={{'--ac':'var(--pur)'}}><div class="stat-lbl">RevPAR</div><div class="stat-val">{BDT(revPAR)}</div><div class="stat-sub">Revenue/Available Room</div></div>
      </div>
      <div class="g2 mb4">
        <div class="card">
          <div class="card-hd">
          ...
          <div class="card-body">
            ...
            <div class="divider"/>
            <div class="flex fjb xs muted"><span>14-day total</span><span class="gold">{BDT(last14.reduce((a,d)=>a+d.v,0))}</span></div>
          </div>
        </div>
        <div class="card">
          <div class="card-hd"><span class="card-title">Revenue by Category</span></div>
          <div class="card-body">
            {topCats.map(([cat,rev])=>(
              <div key={cat} class="flex fac fjb" style={{padding:'5px 0',borderBottom:'1px solid var(--br2)'}}>
                <span class="xs">{cat}</span>
                <div class="flex fac gap2">
                  <span class="xs gold">{BDT(rev)}</span>
      ...
      <div class="card">
        <div class="card-hd"><span class="card-title">Room Category Performance</span></div>
        <div class="tbl-wrap">
          <table class="tbl">
            ...
            <tbody>
              {['Fountain Deluxe','Premium Deluxe','Superior Deluxe','Twin Deluxe','Royal Suite'].map(cat=>{
                ...
                return (<tr key={cat}><td><span class="badge bgold">{cat}</span></td><td class="xs">{cr.length}</td><td class="xs gold">{BDT(rate)}</td><td class="xs">{occN}</td><td class="xs">{pct}%</td><td class="xs gold">{BDT(Math.round(rate*pct/100))}</td></tr>)
              })}
            </tbody>
          </table>
        </div>
    ...
    <div style={{maxWidth:700}}>
      <div class="tabs mb4">
        {[['hotel','🏨 Hotel Info'],['users','👥 Staff & Users'],['devices','📱 Devices'],['system','⚙ System'],['security','🔐 Security']].filter(([v])=>v!=='security'||isSA).map(([v,l])=>(
          <button key={v} class={`tab${tab===v?' on':''}`} onClick={()=>setTab(v)}>{l}</button>
        ))}
      </div>
      ...
      {tab==='hotel'&&(
        <div class="card">
          <div class="card-hd"><span class="card-title">Hotel Information</span>{!isSA&&<span class="badge ba">View Only</span>}</div>
          <div class="card-body">
            <div class="frow">
              <div class="fg"><label class="flbl">Hotel Name</label><input class="finput" value={hs.hotelName} onChange={HS('hotelName')} disabled={!isSA}/></div>
              <div class="fg"><label class="flbl">City / Location</label><input class="finput" value={hs.city} onChange={HS('city')} disabled={!isSA}/></div>
            </div>
            <div class="frow">
              <div class="fg"><label class="flbl">Currency</label>
                <select class="fselect" value={hs.currency} onChange={HS('currency')} disabled={!isSA}>
                  <option value="BDT">BDT — Bangladeshi Taka (৳)</option>
                  <option value="USD">USD — US Dollar ($)</option>
                  <option value="EUR">EUR — Euro (€)</option>
                </select>
              </div>
              <div class="fg"><label class="flbl">Timezone</label><select class="fselect" disabled={!isSA}><option>Asia/Dhaka (UTC+6)</option></select></div>
            </div>
            <div class="frow">
              <div class="fg"><label class="flbl">Standard Check-In</label><input type="time" class="finput" value={hs.checkIn} onChange={HS('checkIn')} disabled={!isSA}/></div>
              <div class="fg"><label class="flbl">Standard Check-Out</label><input type="time" class="finput" value={hs.checkOut} onChange={HS('checkOut')} disabled={!isSA}/></div>
            </div>
            <div class="frow">
              <div class="fg"><label class="flbl">VAT Rate (%)</label><input type="number" class="finput" value={hs.vat} onChange={HS('vat')} disabled={!isSA} min="0" max="30"/></div>
              <div class="fg"><label class="flbl">Service Charge (%)</label><input type="number" class="finput" value={hs.svc} onChange={HS('svc')} disabled={!isSA} min="0" max="30"/></div>
            </div>
            {isSA
              ?<button class="btn btn-gold mt3" disabled={hsSaving} onClick={saveHotelSettings}>{hsSaving?'Saving…':'Save Settings'}</button>
              :<p class="xs muted mt3">Only the Owner can edit hotel settings.</p>
            }
          </div>
        </div>
      )}
      ...
      {tab==='users'&&(
        <div class="card">
          <div class="card-hd">
            ...
            {isSA&&<button class="btn btn-gold btn-sm" onClick={()=>setShowAddUser(true)}>+ Add Staff</button>}
          </div>
          <div class="card-body" style={{display:'flex',flexDirection:'column',gap:10,padding:'15px'}}>
            {staffList.map(u=>(
              <div key={u.id} style={{border:'1px solid var(--brd)',borderRadius:8,padding:'14px 16px',background:'rgba(255,255,255,0.02)',display:'flex',flexDirection:'column',gap:10}}>
                ...
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:8,paddingTop:6,borderTop:'1px solid var(--brd)'}}>
                  <div style={{display:'flex',alignItems:'center',gap:6,flexWrap:'wrap'}}>
                    {u.role==='owner'
                      ?<span class="badge bgold">★ OWNER</span>
                      :<span class="badge bb" style={{textTransform:'uppercase'}}>{ROLES[u.role]?.label||u.role}</span>
                    }
                    {u.activated===false&&(
                  ...
                  {isSA&&u.role!=='owner'&&(
                    <div style={{display:'flex',gap:6,flexShrink:0}}>
                      <button class="btn btn-ghost btn-sm" onClick={()=>setEditUser(u)}>Edit</button>
      ...
      {tab==='devices'&&(
        <div class="card">
          <div class="card-hd"><span class="card-title">Authorized Devices / Terminals</span><span class="badge bgold">{staffList.length} accounts</span></div>
          <div class="card-body" style={{padding:'0 15px'}}>
            {staffList.map(u=>(
              <div key={u.id} class="user-row">
                ...
                <span class={`badge ${u.role==='owner'?'bgold':u.role==='housekeeping'?'bteal':'bb'}`}>{ROLES[u.role]?.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {tab==='system'&&(
        <div>
          <div class="card mb4">
            <div class="card-hd"><span class="card-title">Lumea Founder Mode</span></div>
            <div class="card-body">
              <div style={{background:'rgba(200,169,110,.06)',border:'1px solid rgba(200,169,110,.18)',padding:'12px 14px',marginBottom:14}}>
                ...
                <div class="xs muted" style={{lineHeight:1.8}}>
              ...
              <div class="g2">
                {[['Database','mynwfkgksqqwlqowlscj'],['Region','us-east-1 (N. Virginia)'],['Tenant ID',TENANT.slice(0,18)+'…'],['Plan','Founder Bypass — Unlimited']].map(([l,v])=>(
                  <div key={l} class="info-box"><div class="info-lbl">{l}</div><div class="info-val" style={{fontSize:11}}>{v}</div></div>
                ))}
              </div>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div style={{marginBottom:16}}>
              ...
              <button class="btn-danger" style={{fontFamily:'var(--mono)',fontSize:11,letterSpacing:'.05em'}} onClick={async()=>{
                try{
...
function AddStaffModal({toast,onClose,onAdd,existingIds}) {
  ...
  return (
    <Modal title="Add Staff Account" onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>{saving?'Adding…':'Add Staff'}</button>)}>
      ...
      <div class="frow">
        <div class="fg"><label class="flbl">Full Name *</label><input class="finput" value={f.name} onChange={F('name')} placeholder="Staff name" autoFocus/></div>
        <div class="fg"><label class="flbl">Role *</label>
          <select class="fselect" value={f.role} onChange={F('role')}>
            {Object.entries(ROLES).filter(([k])=>k!=='owner').map(([k,r])=><option key={k} value={k}>{r.label}</option>)}
          </select>
        </div>
      </div>
      <div class="fg" style={{marginBottom:10}}>
        <label class="flbl">Work Email * <span style={{color:'var(--tx3)',fontWeight:400}}>(staff will use this to log in)</span></label>
        <input type="email" class="finput" value={f.email} onChange={F('email')} placeholder="staff@hotel.com"/>
      </div>
      <div class="fg"><label class="flbl">Device / Terminal Name</label><input class="finput" value={f.device} onChange={F('device')} placeholder="e.g. Front Desk Terminal"/></div>
    </Modal>
  )
}
...
function EditStaffModal({user,toast,onClose,onSave}) {
  ...
  return (
    <Modal title={`Edit — ${user.name}`} onClose={onClose}
      footer={React.createElement(React.Fragment,null,<button class="btn btn-ghost" onClick={onClose}>Cancel</button><button class="btn btn-gold" disabled={saving} onClick={save}>{saving?'Saving…':'Save Changes'}</button>)}>
      <div class="frow">
        <div class="fg"><label class="flbl">Full Name</label><input class="finput" value={f.name} onChange={F('name')}/></div>
        <div class="fg"><label class="flbl">Role</label>
          <select class="fselect" value={f.role} onChange={F('role')}>
            {Object.entries(ROLES).filter(([k])=>k!=='owner').map(([k,r])=><option key={k} value={k}>{r.label}</option>)}
          </select>
      ...
      <div class="frow">
        <div class="fg"><label class="flbl">Email</label><input type="email" class="finput" value={f.email} onChange={F('email')}/></div>
        <div class="fg"><label class="flbl">Device / Terminal</label><input class="finput" value={f.device||''} onChange={F('device')}/></div>
      </div>
      <div style={{borderTop:'1px solid var(--br)',marginTop:12,paddingTop:12}}>
        ...
        <button class="btn btn-danger btn-sm" disabled={resetting} onClick={forceReactivate}>
...
function AIAgentsPanel({toast}) {
  ...
  const agentCard=(ico,title,color,desc,children)=>(
    <div class="card mb4" style={{borderColor:color+'33'}}>
      <div class="card-hd" style={{background:color+'0d'}}>
        <span style={{fontSize:18,marginRight:8}}>{ico}</span>
        <span class="card-title">{title}</span>
        <span class="xs muted" style={{marginLeft:8}}>{desc}</span>
      </div>
      <div class="card-body" style={{padding:16}}>{children}</div>
    </div>
  )
  ...
  return (
    <div>
      ...
      {agentCard('🔍','Agent A — The Prospector','#58A6FF','Finds potential leads & saves them to your leads table',(
        <div>
          <div class="fg mb4">
            <label class="flbl">Search Query</label>
            <input class="finput" value={prospectQ} onChange={e=>setProspectQ(e.target.value)} placeholder="e.g. event planners in Dhaka needing hotel rooms"/>
          </div>
          <button class="btn btn-info" disabled={prospectBusy} onClick={runProspect}>
            ...
            <div style={{marginTop:12}}>
              {prospectRes.error
                ?<div>
                  ...
                  {prospectRes.raw&&<details><summary class="xs muted" style={{cursor:'pointer'}}>Raw Gemini output</summary><div style={{background:'var(--s2)',border:'1px solid var(--br)',padding:10,fontSize:10,whiteSpace:'pre-wrap',fontFamily:'monospace',marginTop:6,maxHeight:200,overflow:'auto'}}>{prospectRes.raw}</div></details>}
                </div>
                :<div>
                  <div class="xs muted mb4">✓ {prospectRes.leads_found} leads found, saved & emailed</div>
                  {(prospectRes.raw_leads||prospectRes.leads||[]).map((l,i)=>(
                    <div key={i} style={{background:'var(--s2)',border:'1px solid var(--br2)',padding:'10px 12px',marginBottom:8}}>
                      <div style={{fontWeight:600,fontSize:12}}>{l.name} <span class="xs muted">· {l.company}</span></div>
                      <div class="xs muted">{l.email} · {l.phone}</div>
                      <div class="xs" style={{color:'var(--sky)',marginTop:4}}>{l.notes}</div>
                      {l.source&&<div class="xs muted" style={{marginTop:3}}>Source: {l.source}</div>}
                    </div>
                  ))}
                </div>
              }
      ...
      {agentCard('✉️','Agent B — The Closer','#C8A96E','Writes personalized outreach email for a lead using Gemini',(
        <div>
          <div class="fg mb4">
            <label class="flbl">Lead ID (from leads table)</label>
            <input class="finput" value={leadId} onChange={e=>setLeadId(e.target.value)} placeholder="e.g. 123e4567-e89b-12d3..."/>
          </div>
          <button class="btn btn-gold" disabled={closerBusy} onClick={runCloser}>
          ...
          {closerRes&&(
            <div style={{marginTop:12}}>
              {closerRes.error
                ...
                :<div>
                  <div class="xs muted mb4">Draft written for <strong>{closerRes.lead_name}</strong> — saved to lead notes</div>
      ...
      {agentCard('📊','Agent C — The Analyst','#3FB950','Monitors transactions, spots patterns, suggests discounts',(
        <div>
          <button class="btn btn-ghost" disabled={analystBusy} onClick={runAnalyst} style={{marginBottom:12}}>
                ...
                :<div>
                  ...
                  <div class="g2 mb4">
                    {Object.entries(analystRes.day_averages||{}).sort(([,a],[,b])=>b-a).map(([day,avg])=>(
                      <div key={day} class="info-box" style={{borderColor:day===analystRes.lowest_day?'rgba(224,92,122,.3)':day===analystRes.highest_day?'rgba(63,185,80,.3)':'var(--br2)'}}>
                        <div class="info-lbl">{day}</div>
                        <div class="info-val" style={{color:day===analystRes.lowest_day?'var(--rose)':day===analystRes.highest_day?'var(--grn)':'var(--tx)'}}>{BDT(avg)}</div>
                      </div>
                    ))}
                  </div>
                  {/* Analysis text */}
                  ...
                  {analystRes.needs_approval&&!discountApproved&&(
                    <div style={{background:'rgba(200,169,110,.08)',border:'1px solid var(--br)',padding:'10px 14px',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                      <div>
                        ...
                        <div class="xs muted">{analystRes.suggested_discount}</div>
                      </div>
                      <button class="btn btn-gold btn-sm" onClick={approveDiscount}>✓ Approve &amp; Apply</button>
                    </div>
                  )}
...
function AIResearchPanel({toast}) {
  ...
  return (
    <div>
      ...
      {brief&&(
        <div class="card mb4" style={{borderColor:'rgba(200,169,110,.3)'}}>
          <div class="card-hd" style={{background:'rgba(200,169,110,.06)'}}>
            <span class="card-title">📋 Latest Front Desk Brief</span>
            <span class="xs muted" style={{marginLeft:8}}>{brief.updated_at?new Date(brief.updated_at).toLocaleString():''}</span>
          </div>
          <div class="card-body" style={{whiteSpace:'pre-wrap',fontSize:11,lineHeight:1.8,color:'var(--tx2)'}}>{brief.brief||''}</div>
        </div>
      )}
      ...
      <div class="flex fac fjb mb4" style={{flexWrap:'wrap',gap:8}}>
        <div class="tabs" style={{marginBottom:0}}>
          {['ALL','new','email_drafted','briefed_to_front_desk','contacted','converted'].map(s=>(
            <button key={s} class={`tab${statusF===s?' on':''}`} onClick={()=>setStatusF(s)}>
              {s==='ALL'?`All (${leads.length})`:`${s.replace(/_/g,' ')} (${statusCounts[s]||0})`}
            </button>
          ))}
        </div>
        <div class="flex gap2">
          <div class="srch"><span class="xs muted">⌕</span><input placeholder="Search lead, company, email…" value={search} onChange={e=>setSearch(e.target.value)}/></div>
          <button class="btn btn-ghost btn-sm" onClick={load}>↻ Refresh</button>
        </div>
      </div>

      {loading?<div class="xs muted">Loading research history…</div>
      :rows.length===0?<div class="xs muted" style={{padding:20,textAlign:'center'}}>No AI research yet. Run Agent A (Prospector) to generate leads.</div>
      :(
        <div style={{display:'flex',flexDirection:'column',gap:10}}>
          {rows.map(l=>(
            <div key={l.id} class="card" style={{borderColor:'var(--br2)'}}>
              <div class="card-body" style={{padding:14}}>
                <div class="flex fac fjb" style={{gap:12,flexWrap:'wrap'}}>
                  <div style={{flex:1,minWidth:220}}>
                    <div style={{fontWeight:600,fontSize:13,color:'var(--tx)'}}>{l.name||'Unknown'} <span class="xs muted">· {l.company||'—'}</span></div>
                    <div class="xs muted" style={{marginTop:2}}>{l.email||'no email'} · {l.phone||'no phone'}</div>
                    <div class="xs" style={{color:'var(--sky)',marginTop:6,lineHeight:1.6}}>{l.notes||'—'}</div>
                  </div>
                  <div style={{textAlign:'right',minWidth:120}}>
                    <span class={`badge ${l.status==='converted'?'bgold':l.status==='briefed_to_front_desk'?'bteal':l.status==='email_drafted'?'bb':'ba'}`}>{(l.status||'new').replace(/_/g,' ')}</span>
                    <div class="xs muted" style={{marginTop:4}}>{l.created_at?new Date(l.created_at).toLocaleDateString():''}</div>
                    <div class="xs muted">Source: {l.source||'AI'}</div>
                  </div>
                </div>
                {l.email_draft&&(
                  <details style={{marginTop:10}}>
                    <summary class="xs" style={{cursor:'pointer',color:'var(--gold)'}}>✉ View email draft</summary>
                    ...
                    <button class="btn btn-ghost btn-sm" style={{marginTop:6}} onClick={()=>copyEmail(l.id,l.email_draft)}>📋 Copy</button>
                  </details>
                )}
              </div>
            </div>
    ...
    <div>
      ...
      <div class="tabs mb4">
        {[['recruiter','🔍 Agent 1 — Recruiter'],['butler','🛎 Agent 2 — Portal Butler'],['billing','💰 Agent 3 — Billing Analyst']].map(([v,l])=>(
          <button key={v} class={`tab${activeAgent===v?' on':''}`} onClick={()=>setActiveAgent(v)}>{l}</button>
        ))}
      </div>
        ...
        <div>
          <div class="card mb4">
            ...
            <div style={{display:'flex',gap:8,flexWrap:'wrap'}}>
              <button class="btn btn-gold" onClick={doScan} disabled={busy==='scan'}>{busy==='scan'?'🔄 Scanning…':'🌐 Scan for New Agencies'}</button>
              <button class="btn btn-ghost" onClick={loadPartners} disabled={loadingPartners}>{loadingPartners?'Loading…':'↻ Refresh'}</button>
            </div>
          </div>
          <div class="card">
            <div class="card-hd"><span class="card-title">Partner Agencies ({partners.length})</span></div>
                ...
                <tbody>
                  ...
                  :partners.map(p=>(
                    <tr key={p.id}>
                      ...
                      <td class="xs gold">৳{Number(p.wholesale_rate||2800).toLocaleString()}</td>
                      <td class="xs" style={{color:'var(--tx3)'}}>{p.total_bookings||0}</td>
                      <td>
                        <div style={{display:'flex',gap:4,flexWrap:'wrap'}}>
                          <button class="btn btn-sm" style={{fontSize:9,padding:'3px 8px',background:p.whatsapp_sent?'rgba(63,185,80,.1)':'rgba(37,211,102,.15)',color:p.whatsapp_sent?'var(--grn)':'#25D366',border:'1px solid currentColor'}} disabled={busy===`invite:${p.id}`} onClick={()=>doInvite(p.id, p.agency_name)}>{busy===`invite:${p.id}`?'Sending…':p.whatsapp_sent?'✓ Resend WA':'📱 WhatsApp Invite'}</button>
                          <button class="btn btn-sm btn-gold" style={{fontSize:9,padding:'3px 8px',opacity:p.joining_letter_sent?.9:1}} disabled={busy===`letter:${p.id}`} onClick={()=>doJoiningLetter(p.id, p.agency_name)}>{busy===`letter:${p.id}`?'Generating…':p.joining_letter_sent?'✓ Re-generate Letter':'📄 Joining Letter'}</button>
                        </div>
                      </td>
                    </tr>
                  ))}
      ...
      {activeAgent==='butler'&&(
        <div>
          ...
          <div class="card mb4">
            <div class="card-hd"><span class="card-title">Active Partner Portal Keys</span></div>
            <table class="tbl">
          ...
          <div class="card" style={{background:'rgba(88,166,255,.03)',border:'1px solid rgba(88,166,255,.15)'}}>
        ...
        <div>
          <div class="card mb4">
            ...
            <div style={{display:'flex',gap:8}}>
              <button class="btn btn-gold" onClick={doBillingDashboard} disabled={busy==='dashboard'}>{busy==='dashboard'?'📊 Loading…':'📊 Load B2B Dashboard'}</button>
              <button class="btn btn-gold" onClick={doWeeklyRun} disabled={busy==='weekly'}>{busy==='weekly'?'⚙ Running…':'⚡ Run Weekly Cycle Now'}</button>
            </div>
          </div>
          {dashboard&&(
            <div>
              ...
              {dashboard.recent_bookings?.length>0&&(
                <div class="card mb3">
                  <div class="card-hd"><span class="card-title">Recent B2B Bookings</span></div>
                  <table class="tbl">
                    <thead><tr><th>Partner</th><th>Guest</th><th>Room</th><th>Check-In</th><th>Check-Out</th><th>Revenue</th><th>Commission</th></tr></thead>
                    <tbody>{dashboard.recent_bookings.map(b=>(<tr key={b.id}><td style={{fontSize:11,fontWeight:500}}>{b.partner_name}</td><td style={{fontSize:11}}>{b.guest_name||'—'}</td><td><span class="badge bb">{b.room_number||'—'}</span></td><td class="xs muted">{b.check_in}</td><td class="xs muted">{b.check_out}</td><td class="xs gold">৳{Number(b.total_amount||0).toLocaleString()}</td><td class="xs" style={{color:'var(--grn)'}}>৳{Number(b.commission_amount||0).toLocaleString()}</td></tr>))}</tbody>
                  </table>
                </div>
              )}
            </div>
          ...
          {!dashboard&&!billingResult&&(
            <div class="card" style={{background:'rgba(200,169,110,.03)',border:'1px solid rgba(200,169,110,.15)'}}>
    ...
    <div>
      ...
      <div class="tabs mb4">
        {[['dashboard','📊 Dashboard'],['agent1','✈ Agent 1 · Pre-Arrival'],['agent2','🍽 Agent 2 · Room Customizer'],['offers','📋 All Offers']].map(([v,l])=>(
          <button key={v} class={`tab${activeTab===v?' on':''}`} onClick={()=>setActiveTab(v)}>{l}</button>
        ))}
      </div>
      {activeTab==='dashboard'&&(
        <div>
          {dashboard&&(
            <div>
              ...
              {dashboard?.by_type&&Object.keys(dashboard.by_type).length>0&&(
                <div class="card mb4">
                  <div class="card-hd"><span class="card-title">Performance by Offer Type</span></div>
                  <table class="tbl"><thead><tr><th>Offer</th><th>Sent</th><th>Accepted</th><th>Conversion</th><th>Revenue</th></tr></thead>
                  <tbody>{Object.entries(dashboard.by_type).map(([type,data])=>(<tr key={type}><td><span style={{marginRight:6}}>{offerIcon(type)}</span>{type.replace(/_/g,' ').replace(/\w/g,l=>l.toUpperCase())}</td><td class="xs muted">{data.sent}</td><td class="xs" style={{color:'var(--grn)'}}>{data.accepted}</td><td class="xs gold">{data.sent>0?Math.round(data.accepted/data.sent*100):0}%</td><td class="xs gold">৳{Number(data.revenue||0).toLocaleString()}</td></tr>))}</tbody>
                  </table>
                </div>
              )}
              <div class="card">
                <div class="card-hd"><span class="card-title">Upsell Catalog — Plan G Offers</span></div>
        ...
        <div>
          <div class="card mb4">
            ...
            <div style={{display:'flex',gap:8,flexWrap:'wrap',marginBottom:14}}>
              <button class="btn btn-gold" onClick={()=>runAgent('pre_arrival',null)} disabled={busy==='pre_arrival'}>{busy==='pre_arrival'?'🔄 Running…':'✈ Run for Tomorrow\'s Arrivals'}</button>
            </div>
            <div style={{paddingTop:12,borderTop:'1px solid var(--br2)'}}>
              ...
              <div style={{display:'flex',gap:8}}>
                <select class="finput" style={{flex:1}} value={selectedRes} onChange={e=>setSelectedRes(e.target.value)}>
                ...
                <button class="btn btn-gold btn-sm" style={{padding:'0 14px',whiteSpace:'nowrap'}} disabled={!selectedRes||busy==='pre_arrival'} onClick={()=>runAgent('pre_arrival',selectedRes)}>Send Offers</button>
              </div>
            </div>
          </div>
      ...
      {activeTab==='agent2'&&(
        <div>
          <div class="card mb4">
            ...
            <div style={{display:'flex',gap:8,flexWrap:'wrap',marginBottom:14}}>
              <button class="btn btn-gold" onClick={()=>runAgent('room_customizer',null)} disabled={busy==='room_customizer'}>{busy==='room_customizer'?'🔄 Running…':'🍽 Run for Today\'s Arrivals'}</button>
            </div>
            <div style={{paddingTop:12,borderTop:'1px solid var(--br2)'}}>
              ...
              <div style={{display:'flex',gap:8}}>
                ...
                <button class="btn btn-gold btn-sm" style={{padding:'0 14px',whiteSpace:'nowrap'}} disabled={!selectedRes||busy==='room_customizer'} onClick={()=>runAgent('room_customizer',selectedRes)}>Send Offers</button>
              </div>
            </div>
          </div>
      ...
      {activeTab==='offers'&&(
        <div>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12}}>
            ...
            <button class="btn btn-ghost btn-sm" onClick={()=>{loadOffers();loadDashboard()}}>↻ Refresh</button>
          </div>
          {loadingOffers?(<div style={{textAlign:'center',padding:'24px',color:'var(--tx3)',fontSize:12}}>Loading offers…</div>):(
            <div>
              {offers.length===0&&(<div class="card" style={{textAlign:'center',padding:'24px',color:'var(--tx3)',fontSize:12}}>No offers yet — run Agent 1 or Agent 2 to generate upsell messages</div>)}
              {offers.map(o=>(
      ...
      {replyModal&&(
        <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,.7)',zIndex:9999,display:'flex',alignItems:'center',justifyContent:'center'}} onClick={()=>setReplyModal(null)}>
          <div style={{background:'var(--bg2)',border:'1px solid var(--br)',padding:24,width:480,maxWidth:'90vw'}} onClick={e=>e.stopPropagation()}>
            ...
            <div class="fg mb3"><label class="flbl">Paste their reply message</label><textarea class="finput" rows={4} value={replyText} onChange={e=>setReplyText(e.target.value)} placeholder="e.g. Yes, we're interested! Can we schedule a site visit next week?" style={{resize:'vertical'}}/></div>
            <div style={{display:'flex',gap:8,justifyContent:'flex-end'}}>
              <button class="btn btn-ghost" onClick={()=>setReplyModal(null)}>Cancel</button>
              <button class="btn btn-gold" disabled={!replyText.trim()||busy===`sync:${replyModal.leadId}`} onClick={()=>doSync(replyModal.leadId,replyText)}>{busy===`sync:${replyModal.leadId}`?'Syncing…':'✓ Sync to CRM + Notify Front Desk'}</button>
            </div>
          </div>
        </div>
      )}
          ...
          {dashboard&&(
            <div>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginBottom:16}}>
                <div class="card">
                  <div class="card-hd"><span class="card-title">By Lead Type</span></div>
                ...
                <div class="card">
                  <div class="card-hd"><span class="card-title">By Status</span></div>
              ...
              {dashboard.top_leads?.length>0&&(
                <div class="card">
                  <div class="card-hd"><span class="card-title">Top Priority Leads (Score ≥70)</span></div>
        ...
        <div>
          <div class="card mb4">
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr auto',gap:10,marginBottom:14}}>
              <div>
                <label class="flbl">Lead Type to Scout</label>
                <select class="finput" value={leadType} onChange={e=>setLeadType(e.target.value)}>
              ...
              <div style={{display:'flex',flexDirection:'column',justifyContent:'flex-end'}}>
                <button class="btn btn-gold" onClick={doScout} disabled={busy==='scout'} style={{whiteSpace:'nowrap'}}>{busy==='scout'?'🔄 Scouting…':'🔍 Scout Now'}</button>
              </div>
            </div>
      ...
      {activeTab==='analyst'&&(
        <div>
          <div class="card mb4">
            ...
            <button class="btn btn-gold" onClick={doAnalyzeAll} disabled={busy==='analyze'}>{busy==='analyze'?'🧠 Analyzing…':'🧠 Analyze All Unscored Leads'}</button>
          </div>
          {analystResult&&(
            <div class="card">
        ...
        <div>
          <div class="card mb4">
            ...
            <div style={{display:'flex',gap:8,alignItems:'flex-end',marginBottom:14}}>
              <div style={{flex:1}}>
                <label class="flbl">Auto-outreach score threshold</label>
              ...
              <button class="btn btn-gold" onClick={doBulkOutreach} disabled={busy==='bulk_outreach'} style={{whiteSpace:'nowrap',marginBottom:0}}>{busy==='bulk_outreach'?'📨 Sending…':`📨 Send to All ≥${scoreThreshold}`}</button>
            </div>
      ...
      {activeTab==='leads'&&(
        <div>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12}}>
            ...
            <button class="btn btn-ghost btn-sm" onClick={()=>{loadLeads();loadDashboard()}}>↻ Refresh</button>
          </div>
          {loadingLeads?(<div style={{textAlign:'center',padding:'24px',color:'var(--tx3)',fontSize:12}}>Loading…</div>):(
            leads.length===0?(<div class="card" style={{textAlign:'center',padding:'24px',color:'var(--tx3)',fontSize:12}}>No leads yet — run Agent 1 to scout</div>):
            leads.map(l=>{
                ...
                <div key={l.id} style={{background:'rgba(0,0,0,.12)',border:'1px solid var(--br)',padding:'12px 14px',marginBottom:6}}>
                  <div style={{display:'flex',gap:10,alignItems:'flex-start'}}>
                    ...
                    <div style={{display:'flex',flexDirection:'column',gap:4,flexShrink:0}}>
                      {l.outreach_status==='new'&&(<button class="btn btn-sm" style={{fontSize:9,padding:'3px 8px',background:'rgba(88,166,255,.1)',color:'var(--sky)',border:'1px solid rgba(88,166,255,.3)'}} disabled={busy===`analyze:${l.id}`} onClick={()=>doAnalyzeLead(l.id)}>{busy===`analyze:${l.id}`?'Scoring…':'🧠 Score'}</button>)}
                      {(l.outreach_status==='scored'||l.intent_score>0)&&l.outreach_status!=='outreach_sent'&&l.outreach_status!=='replied'&&(React.createElement(React.Fragment,null,<button class="btn btn-sm btn-gold" style={{fontSize:9,padding:'3px 8px'}} disabled={!!busy} onClick={()=>doOutreachLead(l.id,'linkedin')}>💼 LinkedIn</button><button class="btn btn-sm" style={{fontSize:9,padding:'3px 8px',background:'rgba(37,211,102,.1)',color:'#25D366',border:'1px solid rgba(37,211,102,.3)'}} disabled={!!busy} onClick={()=>doOutreachLead(l.id,'whatsapp')}>📱 WhatsApp</button>))}
                      {l.outreach_status==='outreach_sent'&&(<button class="btn btn-sm" style={{fontSize:9,padding:'3px 8px',background:'rgba(63,185,80,.1)',color:'var(--grn)',border:'1px solid rgba(63,185,80,.3)'}} onClick={()=>{setReplyModal({leadId:l.id,name:l.full_name});setReplyText('')}}>✉ Log Reply</button>)}
                      {l.outreach_status==='replied'&&!l.crm_synced&&(<button class="btn btn-sm btn-gold" style={{fontSize:9,padding:'3px 8px'}} disabled={!!busy} onClick={()=>doSync(l.id,'interested')}>🔄 Sync CRM</button>)}
  ...
  return <div class="card mb4">
    <div class="card-hd">
      <div class="flex fac gap2">
        ...
        <span class="card-title">Email <em style={{fontStyle:'italic',color:'var(--gold)'}}>Workflows</em></span>
      </div>
      <div class="flex fac gap2">
        <div class="sync-dot"/>
        <span class="xs muted">10 cron jobs active</span>
      </div>
    </div>
    <div class="card-body" style={{padding:0}}>
      {loading
        ? <div class="xs muted" style={{padding:'18px',textAlign:'center'}}>Loading workflow history…</div>
        : WORKFLOWS.map((wf,i)=>{
            ...
            return <div key={wf.id} style={{display:'flex',alignItems:'center',gap:12,padding:'10px 16px',borderBottom:i<WORKFLOWS.length-1?'1px solid var(--br2)':'none'}}>
              ...
              {last&&<span class={`badge ${isOk?'bg':'br_'}`} style={{fontSize:8}}>{last.status}</span>}
              <button
                class="btn btn-ghost btn-sm"
                disabled={!!triggering}
                onClick={()=>triggerNow(wf)}
                style={{fontSize:9,padding:'3px 10px',letterSpacing:'.1em'}}
              >{isTrig?React.createElement(React.Fragment,null,<span class="spinner" style={{width:10,height:10}}/>):'▶ Run'}</button>
            </div>
          })
      }
      <div style={{padding:'10px 16px',background:'rgba(200,169,110,.03)',borderTop:'1px solid var(--br2)',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
        <span class="xs muted">All emails → {_HEMAIL}</span>
        <span class="xs muted">{runs.length} runs logged</span>
      </div>
    </div>
  </div>
}
...
function GoogleSheetsCard({toast}) {
  ...
  return <div class="card">
    <div class="card-hd">
      <div class="flex fac gap2"><span style={{fontSize:16}}>📊</span><span class="card-title">Google Sheets <em style={{fontStyle:'italic',color:'var(--gold)'}}>Backup</em></span></div>
      {lastSync&&<span class="badge bg">Synced {new Date(lastSync).toLocaleTimeString()}</span>}
    </div>
    <div class="card-body">
      <div style={{background:'rgba(63,185,80,.05)',border:'1px solid rgba(63,185,80,.15)',padding:'10px 13px',marginBottom:14}}>
        ...
        <div class="xs muted">Every INSERT/UPDATE on all 6 tables syncs to Google Sheets in real-time via database triggers.</div>
      </div>
      {counts&&<div class="g2 mb4">{[['🛏 Rooms',counts.rooms],['👤 Guests',counts.guests],['📅 Reservations',counts.reservations],['💰 Transactions',counts.transactions],['🧾 Folios',counts.folios],['🧹 Housekeeping',counts.housekeeping_tasks]].map(([l,v])=><div key={l} class="info-box"><div class="info-lbl">{l}</div><div class="info-val gold">{v} rows</div></div>)}</div>}
      <div class="fg">
        <label class="flbl">Spreadsheet ID</label>
        <input class="finput" value={sheetId} onChange={e=>setSheetId(e.target.value.trim())} placeholder="Paste Spreadsheet ID"/>
      </div>
      <div class="flex gap2" style={{flexWrap:'wrap'}}>
        <button class="btn btn-gold" disabled={syncing} onClick={runSync}>{syncing?React.createElement(React.Fragment,null,<span class="spinner" style={{width:12,height:12}}/>{' '}Syncing…):'📊 Sync All Data Now'}</button>
        {sheetId&&<a href={`https://docs.google.com/spreadsheets/d/${sheetId}/edit`} target="_blank" rel="noopener" class="btn btn-ghost">↗ Open Sheet</a>}
      </div>
    </div>
  </div>
}
  ...
  return (
    React.createElement(React.Fragment,null,
      ...
      <div class="app">
        ...
        <aside class="sidebar">
          <div class="s-head">
            <div class="s-brand">Hotel <em>Fountain</em></div>
            <div class="s-tag">The Pulse of Modern Hospitality</div>
            <div class="s-hotel">🏨 Management CRM</div>
          </div>
          <nav class="s-nav">
            {NAV_ITEMS.map(item=>(
              <div key={item.id}>
                {item.sect&&<div class="s-sect">{item.sect}</div>}
                <div class={`nav-item${cur===item.id?' on':''}`} onClick={()=>setPage(item.id)}>
                  <span class="ico">{item.ico}</span>
                  <span>{item.label}</span>
                  {item.badge>0&&<span class="n-badge">{item.badge}</span>}
                </div>
              </div>
            ))}
          </nav>
          <div class="s-foot">
            <div class="flex fac gap2">
              <div class="av" style={{width:30,height:30,fontSize:11,background:`linear-gradient(135deg,${avColor(user.name)},rgba(0,0,0,.5))`,color:'#EEE9E2',flexShrink:0,fontFamily:'var(--sans)',fontWeight:400}}>
                {user.av}
              </div>
              <div style={{flex:1,minWidth:0}}>
        ...
        <main class="main">
          <div class="topbar">
            <div class="tb-title">{PAGE_TITLES[cur]}</div>
            <div class="flex fac gap2"><div class="sync-dot"/><span class="xs muted">Live</span></div>
            <div class="tb-meta">{clockStr}</div>
